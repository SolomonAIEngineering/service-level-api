...
type LinkedAccountingAccountORM struct {
	...
	CashFlowStatements               []*CashFlowStatementsORM      `gorm:"foreignkey:LinkedAccountingAccountId;association_foreignkey:Id;preload:true"`
	ChartOfAccounts                  []*BusinessChartOfAccountsORM `gorm:"foreignkey:LinkedAccountingAccountId;association_foreignkey:Id;preload:true"`
