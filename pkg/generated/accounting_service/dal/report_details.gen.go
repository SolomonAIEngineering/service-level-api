...
func newReportDetailsORM(db *gorm.DB, opts ...gen.DOOption) reportDetailsORM {
	...
	_reportDetailsORM.reportDetailsORMDo.UseModel(&accounting_servicev1.ReportDetailsORM{})
...
func (a reportDetailsORMHasManyBalanceSheets) Model(m *accounting_servicev1.ReportDetailsORM) *reportDetailsORMHasManyBalanceSheetsTx {
...
func (a reportDetailsORMHasManyBalanceSheetsTx) Find() (result []*accounting_servicev1.BalanceSheetORM, err error) {
	return result, a.tx.Find(&result)
}

func (a reportDetailsORMHasManyBalanceSheetsTx) Append(values ...*accounting_servicev1.BalanceSheetORM) (err error) {
...
func (a reportDetailsORMHasManyBalanceSheetsTx) Replace(values ...*accounting_servicev1.BalanceSheetORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a reportDetailsORMHasManyBalanceSheetsTx) Delete(values ...*accounting_servicev1.BalanceSheetORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a reportDetailsORMHasManyCashFlowStatements) Model(m *accounting_servicev1.ReportDetailsORM) *reportDetailsORMHasManyCashFlowStatementsTx {
...
func (a reportDetailsORMHasManyCashFlowStatementsTx) Find() (result []*accounting_servicev1.CashFlowStatementsORM, err error) {
	return result, a.tx.Find(&result)
}

func (a reportDetailsORMHasManyCashFlowStatementsTx) Append(values ...*accounting_servicev1.CashFlowStatementsORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a reportDetailsORMHasManyCashFlowStatementsTx) Replace(values ...*accounting_servicev1.CashFlowStatementsORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a reportDetailsORMHasManyCashFlowStatementsTx) Delete(values ...*accounting_servicev1.CashFlowStatementsORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a reportDetailsORMHasManyIncomeStatements) Model(m *accounting_servicev1.ReportDetailsORM) *reportDetailsORMHasManyIncomeStatementsTx {
...
func (a reportDetailsORMHasManyIncomeStatementsTx) Find() (result []*accounting_servicev1.IncomeStatementORM, err error) {
	return result, a.tx.Find(&result)
}

func (a reportDetailsORMHasManyIncomeStatementsTx) Append(values ...*accounting_servicev1.IncomeStatementORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a reportDetailsORMHasManyIncomeStatementsTx) Replace(values ...*accounting_servicev1.IncomeStatementORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a reportDetailsORMHasManyIncomeStatementsTx) Delete(values ...*accounting_servicev1.IncomeStatementORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type IReportDetailsORMDo interface {
	...
	Create(values ...*accounting_servicev1.ReportDetailsORM) error
	CreateInBatches(values []*accounting_servicev1.ReportDetailsORM, batchSize int) error
	Save(values ...*accounting_servicev1.ReportDetailsORM) error
	First() (*accounting_servicev1.ReportDetailsORM, error)
	Take() (*accounting_servicev1.ReportDetailsORM, error)
	Last() (*accounting_servicev1.ReportDetailsORM, error)
	Find() ([]*accounting_servicev1.ReportDetailsORM, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*accounting_servicev1.ReportDetailsORM, err error)
	FindInBatches(result *[]*accounting_servicev1.ReportDetailsORM, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*accounting_servicev1.ReportDetailsORM) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*accounting_servicev1.ReportDetailsORM, error)
	FirstOrCreate() (*accounting_servicev1.ReportDetailsORM, error)
	FindByPage(offset int, limit int) (result []*accounting_servicev1.ReportDetailsORM, count int64, err error)
	...
	GetRecordByID(id int) (result accounting_servicev1.ReportDetailsORM, err error)
	GetRecordByIDs(ids []int) (result []accounting_servicev1.ReportDetailsORM, err error)
	CreateRecord(item accounting_servicev1.ReportDetailsORM) (err error)
	UpdateRecordByID(id int, item accounting_servicev1.ReportDetailsORM) (err error)
	DeleteRecordByID(id int) (err error)
	GetAllRecords(orderColumn string, limit int, offset int) (result []accounting_servicev1.ReportDetailsORM, err error)
	CountAll() (result int, err error)
	GetByID(id uint64) (result accounting_servicev1.ReportDetailsORM, err error)
	GetByIDs(ids []uint64) (result []accounting_servicev1.ReportDetailsORM, err error)
}
...
//
// {{end}}
func (r reportDetailsORMDo) GetRecordByID(id int) (result accounting_servicev1.ReportDetailsORM, err error) {
...
//
// {{end}}
func (r reportDetailsORMDo) GetRecordByIDs(ids []int) (result []accounting_servicev1.ReportDetailsORM, err error) {
	var params []interface{}
...
func (r reportDetailsORMDo) CreateRecord(item accounting_servicev1.ReportDetailsORM) (err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (r reportDetailsORMDo) UpdateRecordByID(id int, item accounting_servicev1.ReportDetailsORM) (err error) {
	var params []interface{}
...
func (r reportDetailsORMDo) GetAllRecords(orderColumn string, limit int, offset int) (result []accounting_servicev1.ReportDetailsORM, err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (r reportDetailsORMDo) GetByID(id uint64) (result accounting_servicev1.ReportDetailsORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (r reportDetailsORMDo) GetByIDs(ids []uint64) (result []accounting_servicev1.ReportDetailsORM, err error) {
	var params []interface{}
...
func (r reportDetailsORMDo) Create(values ...*accounting_servicev1.ReportDetailsORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (r reportDetailsORMDo) CreateInBatches(values []*accounting_servicev1.ReportDetailsORM, batchSize int) error {
	return r.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (r reportDetailsORMDo) Save(values ...*accounting_servicev1.ReportDetailsORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (r reportDetailsORMDo) First() (*accounting_servicev1.ReportDetailsORM, error) {
	if result, err := r.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*accounting_servicev1.ReportDetailsORM), nil
	}
}

func (r reportDetailsORMDo) Take() (*accounting_servicev1.ReportDetailsORM, error) {
...
func (r reportDetailsORMDo) Last() (*accounting_servicev1.ReportDetailsORM, error) {
...
func (r reportDetailsORMDo) Find() ([]*accounting_servicev1.ReportDetailsORM, error) {
	result, err := r.DO.Find()
	return result.([]*accounting_servicev1.ReportDetailsORM), err
}

func (r reportDetailsORMDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*accounting_servicev1.ReportDetailsORM, err error) {
	buf := make([]*accounting_servicev1.ReportDetailsORM, 0, batchSize)
...
func (r reportDetailsORMDo) FindInBatches(result *[]*accounting_servicev1.ReportDetailsORM, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (r reportDetailsORMDo) FirstOrInit() (*accounting_servicev1.ReportDetailsORM, error) {
...
func (r reportDetailsORMDo) FirstOrCreate() (*accounting_servicev1.ReportDetailsORM, error) {
...
func (r reportDetailsORMDo) FindByPage(offset int, limit int) (result []*accounting_servicev1.ReportDetailsORM, count int64, err error) {
...
func (r reportDetailsORMDo) Delete(models ...*accounting_servicev1.ReportDetailsORM) (result gen.ResultInfo, err error) {
