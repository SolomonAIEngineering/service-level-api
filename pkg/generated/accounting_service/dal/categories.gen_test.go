...
func init() {
	InitializeDB()
	err := db.AutoMigrate(&accounting_servicev1.CategoryORM{})
	if err != nil {
		fmt.Printf("Error: AutoMigrate(&accounting_servicev1.CategoryORM{}) fail: %s", err)
	}
}
...
func Test_categoryORMQuery(t *testing.T) {
	...
	err = _do.Create(&accounting_servicev1.CategoryORM{})
	if err != nil {
		t.Error("create item in table <categories> fail:", err)
	}

	err = _do.Save(&accounting_servicev1.CategoryORM{})
	if err != nil {
		t.Error("create item in table <categories> fail:", err)
	}

	err = _do.CreateInBatches([]*accounting_servicev1.CategoryORM{{}, {}}, 10)
	if err != nil {
		t.Error("create item in table <categories> fail:", err)
	}
	...
	err = _do.Where(primaryKey.IsNotNull()).FindInBatches(&[]*accounting_servicev1.CategoryORM{}, 10, func(tx gen.Dao, batch int) error { return nil })
	if err != nil {
	...
	_, err = _do.ScanByPage(&accounting_servicev1.CategoryORM{}, 0, 1)
	if err != nil {
...
func Test_categoryORM_CreateRecord(t *testing.T) {
	...
	for i, tt := range CategoryORMCreateRecordTestCase {
		t.Run("CreateRecord_"+strconv.Itoa(i), func(t *testing.T) {
			res1 := do.CreateRecord(tt.Input.Args[0].(accounting_servicev1.CategoryORM))
...
func Test_categoryORM_UpdateRecordByID(t *testing.T) {
	...
	for i, tt := range CategoryORMUpdateRecordByIDTestCase {
		t.Run("UpdateRecordByID_"+strconv.Itoa(i), func(t *testing.T) {
			res1 := do.UpdateRecordByID(tt.Input.Args[0].(int), tt.Input.Args[1].(accounting_servicev1.CategoryORM))
