...
func newTransactionDetailsORM(db *gorm.DB, opts ...gen.DOOption) transactionDetailsORM {
	...
	_transactionDetailsORM.transactionDetailsORMDo.UseModel(&accounting_servicev1.TransactionDetailsORM{})
...
func (a transactionDetailsORMHasManyCreditNotes) Model(m *accounting_servicev1.TransactionDetailsORM) *transactionDetailsORMHasManyCreditNotesTx {
...
func (a transactionDetailsORMHasManyCreditNotesTx) Find() (result []*accounting_servicev1.CreditNoteORM, err error) {
	return result, a.tx.Find(&result)
}

func (a transactionDetailsORMHasManyCreditNotesTx) Append(values ...*accounting_servicev1.CreditNoteORM) (err error) {
...
func (a transactionDetailsORMHasManyCreditNotesTx) Replace(values ...*accounting_servicev1.CreditNoteORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a transactionDetailsORMHasManyCreditNotesTx) Delete(values ...*accounting_servicev1.CreditNoteORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a transactionDetailsORMHasManyExpenses) Model(m *accounting_servicev1.TransactionDetailsORM) *transactionDetailsORMHasManyExpensesTx {
...
func (a transactionDetailsORMHasManyExpensesTx) Find() (result []*accounting_servicev1.ExpenseORM, err error) {
	return result, a.tx.Find(&result)
}

func (a transactionDetailsORMHasManyExpensesTx) Append(values ...*accounting_servicev1.ExpenseORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a transactionDetailsORMHasManyExpensesTx) Replace(values ...*accounting_servicev1.ExpenseORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a transactionDetailsORMHasManyExpensesTx) Delete(values ...*accounting_servicev1.ExpenseORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a transactionDetailsORMHasManyInvoices) Model(m *accounting_servicev1.TransactionDetailsORM) *transactionDetailsORMHasManyInvoicesTx {
...
func (a transactionDetailsORMHasManyInvoicesTx) Find() (result []*accounting_servicev1.InvoiceORM, err error) {
	return result, a.tx.Find(&result)
}

func (a transactionDetailsORMHasManyInvoicesTx) Append(values ...*accounting_servicev1.InvoiceORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a transactionDetailsORMHasManyInvoicesTx) Replace(values ...*accounting_servicev1.InvoiceORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a transactionDetailsORMHasManyInvoicesTx) Delete(values ...*accounting_servicev1.InvoiceORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a transactionDetailsORMHasManyJournalEntries) Model(m *accounting_servicev1.TransactionDetailsORM) *transactionDetailsORMHasManyJournalEntriesTx {
...
func (a transactionDetailsORMHasManyJournalEntriesTx) Find() (result []*accounting_servicev1.JournalEntryORM, err error) {
	return result, a.tx.Find(&result)
}

func (a transactionDetailsORMHasManyJournalEntriesTx) Append(values ...*accounting_servicev1.JournalEntryORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a transactionDetailsORMHasManyJournalEntriesTx) Replace(values ...*accounting_servicev1.JournalEntryORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a transactionDetailsORMHasManyJournalEntriesTx) Delete(values ...*accounting_servicev1.JournalEntryORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a transactionDetailsORMHasManyPayments) Model(m *accounting_servicev1.TransactionDetailsORM) *transactionDetailsORMHasManyPaymentsTx {
...
func (a transactionDetailsORMHasManyPaymentsTx) Find() (result []*accounting_servicev1.PaymentORM, err error) {
	return result, a.tx.Find(&result)
}

func (a transactionDetailsORMHasManyPaymentsTx) Append(values ...*accounting_servicev1.PaymentORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a transactionDetailsORMHasManyPaymentsTx) Replace(values ...*accounting_servicev1.PaymentORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a transactionDetailsORMHasManyPaymentsTx) Delete(values ...*accounting_servicev1.PaymentORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a transactionDetailsORMHasManyTransactions) Model(m *accounting_servicev1.TransactionDetailsORM) *transactionDetailsORMHasManyTransactionsTx {
...
func (a transactionDetailsORMHasManyTransactionsTx) Find() (result []*accounting_servicev1.BusinessTransactionORM, err error) {
	return result, a.tx.Find(&result)
}

func (a transactionDetailsORMHasManyTransactionsTx) Append(values ...*accounting_servicev1.BusinessTransactionORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a transactionDetailsORMHasManyTransactionsTx) Replace(values ...*accounting_servicev1.BusinessTransactionORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a transactionDetailsORMHasManyTransactionsTx) Delete(values ...*accounting_servicev1.BusinessTransactionORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a transactionDetailsORMHasManyVendorCredits) Model(m *accounting_servicev1.TransactionDetailsORM) *transactionDetailsORMHasManyVendorCreditsTx {
...
func (a transactionDetailsORMHasManyVendorCreditsTx) Find() (result []*accounting_servicev1.VendorCreditORM, err error) {
	return result, a.tx.Find(&result)
}

func (a transactionDetailsORMHasManyVendorCreditsTx) Append(values ...*accounting_servicev1.VendorCreditORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a transactionDetailsORMHasManyVendorCreditsTx) Replace(values ...*accounting_servicev1.VendorCreditORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a transactionDetailsORMHasManyVendorCreditsTx) Delete(values ...*accounting_servicev1.VendorCreditORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type ITransactionDetailsORMDo interface {
	...
	Create(values ...*accounting_servicev1.TransactionDetailsORM) error
	CreateInBatches(values []*accounting_servicev1.TransactionDetailsORM, batchSize int) error
	Save(values ...*accounting_servicev1.TransactionDetailsORM) error
	First() (*accounting_servicev1.TransactionDetailsORM, error)
	Take() (*accounting_servicev1.TransactionDetailsORM, error)
	Last() (*accounting_servicev1.TransactionDetailsORM, error)
	Find() ([]*accounting_servicev1.TransactionDetailsORM, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*accounting_servicev1.TransactionDetailsORM, err error)
	FindInBatches(result *[]*accounting_servicev1.TransactionDetailsORM, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*accounting_servicev1.TransactionDetailsORM) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*accounting_servicev1.TransactionDetailsORM, error)
	FirstOrCreate() (*accounting_servicev1.TransactionDetailsORM, error)
	FindByPage(offset int, limit int) (result []*accounting_servicev1.TransactionDetailsORM, count int64, err error)
	...
	GetRecordByID(id int) (result accounting_servicev1.TransactionDetailsORM, err error)
	GetRecordByIDs(ids []int) (result []accounting_servicev1.TransactionDetailsORM, err error)
	CreateRecord(item accounting_servicev1.TransactionDetailsORM) (err error)
	UpdateRecordByID(id int, item accounting_servicev1.TransactionDetailsORM) (err error)
	DeleteRecordByID(id int) (err error)
	GetAllRecords(orderColumn string, limit int, offset int) (result []accounting_servicev1.TransactionDetailsORM, err error)
	CountAll() (result int, err error)
	GetByID(id uint64) (result accounting_servicev1.TransactionDetailsORM, err error)
	GetByIDs(ids []uint64) (result []accounting_servicev1.TransactionDetailsORM, err error)
}
...
//
// {{end}}
func (t transactionDetailsORMDo) GetRecordByID(id int) (result accounting_servicev1.TransactionDetailsORM, err error) {
...
//
// {{end}}
func (t transactionDetailsORMDo) GetRecordByIDs(ids []int) (result []accounting_servicev1.TransactionDetailsORM, err error) {
	var params []interface{}
...
func (t transactionDetailsORMDo) CreateRecord(item accounting_servicev1.TransactionDetailsORM) (err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (t transactionDetailsORMDo) UpdateRecordByID(id int, item accounting_servicev1.TransactionDetailsORM) (err error) {
	var params []interface{}
...
func (t transactionDetailsORMDo) GetAllRecords(orderColumn string, limit int, offset int) (result []accounting_servicev1.TransactionDetailsORM, err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (t transactionDetailsORMDo) GetByID(id uint64) (result accounting_servicev1.TransactionDetailsORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (t transactionDetailsORMDo) GetByIDs(ids []uint64) (result []accounting_servicev1.TransactionDetailsORM, err error) {
	var params []interface{}
...
func (t transactionDetailsORMDo) Create(values ...*accounting_servicev1.TransactionDetailsORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (t transactionDetailsORMDo) CreateInBatches(values []*accounting_servicev1.TransactionDetailsORM, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t transactionDetailsORMDo) Save(values ...*accounting_servicev1.TransactionDetailsORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (t transactionDetailsORMDo) First() (*accounting_servicev1.TransactionDetailsORM, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*accounting_servicev1.TransactionDetailsORM), nil
	}
}

func (t transactionDetailsORMDo) Take() (*accounting_servicev1.TransactionDetailsORM, error) {
...
func (t transactionDetailsORMDo) Last() (*accounting_servicev1.TransactionDetailsORM, error) {
...
func (t transactionDetailsORMDo) Find() ([]*accounting_servicev1.TransactionDetailsORM, error) {
	result, err := t.DO.Find()
	return result.([]*accounting_servicev1.TransactionDetailsORM), err
}

func (t transactionDetailsORMDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*accounting_servicev1.TransactionDetailsORM, err error) {
	buf := make([]*accounting_servicev1.TransactionDetailsORM, 0, batchSize)
...
func (t transactionDetailsORMDo) FindInBatches(result *[]*accounting_servicev1.TransactionDetailsORM, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t transactionDetailsORMDo) FirstOrInit() (*accounting_servicev1.TransactionDetailsORM, error) {
...
func (t transactionDetailsORMDo) FirstOrCreate() (*accounting_servicev1.TransactionDetailsORM, error) {
...
func (t transactionDetailsORMDo) FindByPage(offset int, limit int) (result []*accounting_servicev1.TransactionDetailsORM, count int64, err error) {
...
func (t transactionDetailsORMDo) Delete(models ...*accounting_servicev1.TransactionDetailsORM) (result gen.ResultInfo, err error) {
