...
type FollowerORM struct {
	ApprovedAt                 string
	BackendWideUserFollowedId  string
	BackendWideUserFollowingId string
	CreatedAt                  string
	Id                         uint64
...
func (m *Follower) ToORM(ctx context.Context) (FollowerORM, error) {
	...
	to.Id = m.Id
	to.BackendWideUserFollowedId = m.BackendWideUserFollowedId
	to.BackendWideUserFollowingId = m.BackendWideUserFollowingId
...
func DefaultApplyFieldMaskFollower(ctx context.Context, patchee *Follower, patcher *Follower, updateMask *field_mask.FieldMask, prefix string, db *gorm.DB) (*Follower, error) {
	...
	for _, f := range updateMask.Paths {
		...
		if f == prefix+"BackendWideUserFollowedId" {
			patchee.BackendWideUserFollowedId = patcher.BackendWideUserFollowedId
			continue
		}
		if f == prefix+"BackendWideUserFollowingId" {
			patchee.BackendWideUserFollowingId = patcher.BackendWideUserFollowingId
			continue
		}
