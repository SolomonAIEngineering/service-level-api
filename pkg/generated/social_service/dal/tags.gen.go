...
func newTagsORM(db *gorm.DB, opts ...gen.DOOption) tagsORM {
	...
	_tagsORM.tagsORMDo.UseModel(&social_servicev2.TagsORM{})

	tableName := _tagsORM.tagsORMDo.TableName()
	_tagsORM.ALL = field.NewAsterisk(tableName)
	_tagsORM.Description = field.NewString(tableName, "description")
	_tagsORM.Id = field.NewUint64(tableName, "id")
	_tagsORM.TagName = field.NewString(tableName, "tag_name")
	_tagsORM.UserProfileId = field.NewUint64(tableName, "user_profile_id")
...
func (t *tagsORM) updateTableName(table string) *tagsORM {
	...
	t.UserProfileId = field.NewUint64(table, "user_profile_id")
...
func (t *tagsORM) fillFieldMap() {
	...
	t.fieldMap["user_profile_id"] = t.UserProfileId
}
...
type ITagsORMDo interface {
	...
	Unscoped() ITagsORMDo
	Create(values ...*social_servicev2.TagsORM) error
	CreateInBatches(values []*social_servicev2.TagsORM, batchSize int) error
	Save(values ...*social_servicev2.TagsORM) error
	First() (*social_servicev2.TagsORM, error)
	Take() (*social_servicev2.TagsORM, error)
	Last() (*social_servicev2.TagsORM, error)
	Find() ([]*social_servicev2.TagsORM, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*social_servicev2.TagsORM, err error)
	FindInBatches(result *[]*social_servicev2.TagsORM, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*social_servicev2.TagsORM) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*social_servicev2.TagsORM, error)
	FirstOrCreate() (*social_servicev2.TagsORM, error)
	FindByPage(offset int, limit int) (result []*social_servicev2.TagsORM, count int64, err error)
	...
	GetRecordByID(id int) (result social_servicev2.TagsORM, err error)
	GetRecordByIDs(ids []int) (result []social_servicev2.TagsORM, err error)
	CreateRecord(item social_servicev2.TagsORM) (err error)
	UpdateRecordByID(id int, item social_servicev2.TagsORM) (err error)
	DeleteRecordByID(id int) (err error)
	GetAllRecords(orderColumn string, limit int, offset int) (result []social_servicev2.TagsORM, err error)
...
//
// {{end}}
func (t tagsORMDo) GetRecordByID(id int) (result social_servicev2.TagsORM, err error) {
...
//
// {{end}}
func (t tagsORMDo) GetRecordByIDs(ids []int) (result []social_servicev2.TagsORM, err error) {
	var params []interface{}
...
func (t tagsORMDo) CreateRecord(item social_servicev2.TagsORM) (err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (t tagsORMDo) UpdateRecordByID(id int, item social_servicev2.TagsORM) (err error) {
	var params []interface{}
...
func (t tagsORMDo) GetAllRecords(orderColumn string, limit int, offset int) (result []social_servicev2.TagsORM, err error) {
	var generateSQL strings.Builder
...
func (t tagsORMDo) Create(values ...*social_servicev2.TagsORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tagsORMDo) CreateInBatches(values []*social_servicev2.TagsORM, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t tagsORMDo) Save(values ...*social_servicev2.TagsORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tagsORMDo) First() (*social_servicev2.TagsORM, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*social_servicev2.TagsORM), nil
	}
}

func (t tagsORMDo) Take() (*social_servicev2.TagsORM, error) {
...
func (t tagsORMDo) Last() (*social_servicev2.TagsORM, error) {
...
func (t tagsORMDo) Find() ([]*social_servicev2.TagsORM, error) {
	result, err := t.DO.Find()
	return result.([]*social_servicev2.TagsORM), err
}

func (t tagsORMDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*social_servicev2.TagsORM, err error) {
	buf := make([]*social_servicev2.TagsORM, 0, batchSize)
...
func (t tagsORMDo) FindInBatches(result *[]*social_servicev2.TagsORM, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t tagsORMDo) FirstOrInit() (*social_servicev2.TagsORM, error) {
...
func (t tagsORMDo) FirstOrCreate() (*social_servicev2.TagsORM, error) {
...
func (t tagsORMDo) FindByPage(offset int, limit int) (result []*social_servicev2.TagsORM, count int64, err error) {
...
func (t tagsORMDo) Delete(models ...*social_servicev2.TagsORM) (result gen.ResultInfo, err error) {
