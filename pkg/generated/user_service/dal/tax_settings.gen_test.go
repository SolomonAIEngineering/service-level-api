...
var TaxSettingsORMGetByIDTestCase = []TestCase{}

func Test_taxSettingsORM_GetByID(t *testing.T) {
	taxSettingsORM := newTaxSettingsORM(db)
	do := taxSettingsORM.WithContext(context.Background()).Debug()

	for i, tt := range TaxSettingsORMGetByIDTestCase {
...
var TaxSettingsORMGetByIDsTestCase = []TestCase{}

func Test_taxSettingsORM_GetByIDs(t *testing.T) {
	taxSettingsORM := newTaxSettingsORM(db)
	do := taxSettingsORM.WithContext(context.Background()).Debug()

	for i, tt := range TaxSettingsORMGetByIDsTestCase {
