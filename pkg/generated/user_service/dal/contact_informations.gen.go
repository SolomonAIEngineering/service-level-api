...
type IContactInformationORMDo interface {
	...
	GetByID(id uint64) (result user_servicev1.ContactInformationORM, err error)
	GetByIDs(ids []uint64) (result []user_servicev1.ContactInformationORM, err error)
}
...
//
// {{end}}
func (c contactInformationORMDo) GetByID(id uint64) (result user_servicev1.ContactInformationORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (c contactInformationORMDo) GetByIDs(ids []uint64) (result []user_servicev1.ContactInformationORM, err error) {
	var params []interface{}
