...
type IBusinessAccountSettingsORMDo interface {
	...
	GetByID(id uint64) (result user_servicev1.BusinessAccountSettingsORM, err error)
	GetByIDs(ids []uint64) (result []user_servicev1.BusinessAccountSettingsORM, err error)
}
...
//
// {{end}}
func (b businessAccountSettingsORMDo) GetByID(id uint64) (result user_servicev1.BusinessAccountSettingsORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (b businessAccountSettingsORMDo) GetByIDs(ids []uint64) (result []user_servicev1.BusinessAccountSettingsORM, err error) {
	var params []interface{}
