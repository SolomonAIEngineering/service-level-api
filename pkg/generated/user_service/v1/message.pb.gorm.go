...
type UserAccountORM struct {
	...
	UserSettings    *UserSettingsORM `gorm:"foreignkey:UserAccountId;association_foreignkey:Id"`
	Username        string
...
type BusinessAccountORM struct {
	...
	AuthnAccountId          uint64
	Bio                     string
	BusinessAccountSettings *BusinessAccountSettingsORM `gorm:"foreignkey:BusinessAccountId;association_foreignkey:Id;preload:true"`
...
func DefaultStrictUpdateBusinessAccount(ctx context.Context, in *BusinessAccount, db *gorm.DB) (*BusinessAccount, error) {
	...
	*filterAddress.BusinessAccountId = ormObj.Id
	...
	filterBusinessAccountSettings.BusinessAccountId = new(uint64)
	*filterBusinessAccountSettings.BusinessAccountId = ormObj.Id
