...
func newReferenceDetailsORM(db *gorm.DB, opts ...gen.DOOption) referenceDetailsORM {
	...
	_referenceDetailsORM.referenceDetailsORMDo.UseModel(&financial_servicev1.ReferenceDetailsORM{})
	...
	_referenceDetailsORM.ChartOfAccounts = referenceDetailsORMHasManyChartOfAccounts{
		...
		RelationField: field.NewRelation("ChartOfAccounts", "financial_servicev1.BusinessChartOfAccountsORM"),
	}

	_referenceDetailsORM.Contacts = referenceDetailsORMHasManyContacts{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("Contacts", "financial_servicev1.ContactsORM"),
	}

	_referenceDetailsORM.Items = referenceDetailsORMHasManyItems{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("Items", "financial_servicev1.ItemORM"),
	}

	_referenceDetailsORM.TaxRates = referenceDetailsORMHasManyTaxRates{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("TaxRates", "financial_servicev1.TaxRateORM"),
	}
...
func (a referenceDetailsORMHasManyChartOfAccounts) Model(m *financial_servicev1.ReferenceDetailsORM) *referenceDetailsORMHasManyChartOfAccountsTx {
...
func (a referenceDetailsORMHasManyChartOfAccountsTx) Find() (result []*financial_servicev1.BusinessChartOfAccountsORM, err error) {
	return result, a.tx.Find(&result)
}

func (a referenceDetailsORMHasManyChartOfAccountsTx) Append(values ...*financial_servicev1.BusinessChartOfAccountsORM) (err error) {
...
func (a referenceDetailsORMHasManyChartOfAccountsTx) Replace(values ...*financial_servicev1.BusinessChartOfAccountsORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a referenceDetailsORMHasManyChartOfAccountsTx) Delete(values ...*financial_servicev1.BusinessChartOfAccountsORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a referenceDetailsORMHasManyContacts) Model(m *financial_servicev1.ReferenceDetailsORM) *referenceDetailsORMHasManyContactsTx {
...
func (a referenceDetailsORMHasManyContactsTx) Find() (result []*financial_servicev1.ContactsORM, err error) {
	return result, a.tx.Find(&result)
}

func (a referenceDetailsORMHasManyContactsTx) Append(values ...*financial_servicev1.ContactsORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a referenceDetailsORMHasManyContactsTx) Replace(values ...*financial_servicev1.ContactsORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a referenceDetailsORMHasManyContactsTx) Delete(values ...*financial_servicev1.ContactsORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a referenceDetailsORMHasManyItems) Model(m *financial_servicev1.ReferenceDetailsORM) *referenceDetailsORMHasManyItemsTx {
...
func (a referenceDetailsORMHasManyItemsTx) Find() (result []*financial_servicev1.ItemORM, err error) {
	return result, a.tx.Find(&result)
}

func (a referenceDetailsORMHasManyItemsTx) Append(values ...*financial_servicev1.ItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a referenceDetailsORMHasManyItemsTx) Replace(values ...*financial_servicev1.ItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a referenceDetailsORMHasManyItemsTx) Delete(values ...*financial_servicev1.ItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a referenceDetailsORMHasManyTaxRates) Model(m *financial_servicev1.ReferenceDetailsORM) *referenceDetailsORMHasManyTaxRatesTx {
...
func (a referenceDetailsORMHasManyTaxRatesTx) Find() (result []*financial_servicev1.TaxRateORM, err error) {
	return result, a.tx.Find(&result)
}

func (a referenceDetailsORMHasManyTaxRatesTx) Append(values ...*financial_servicev1.TaxRateORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a referenceDetailsORMHasManyTaxRatesTx) Replace(values ...*financial_servicev1.TaxRateORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a referenceDetailsORMHasManyTaxRatesTx) Delete(values ...*financial_servicev1.TaxRateORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type IReferenceDetailsORMDo interface {
	...
	Create(values ...*financial_servicev1.ReferenceDetailsORM) error
	CreateInBatches(values []*financial_servicev1.ReferenceDetailsORM, batchSize int) error
	Save(values ...*financial_servicev1.ReferenceDetailsORM) error
	First() (*financial_servicev1.ReferenceDetailsORM, error)
	Take() (*financial_servicev1.ReferenceDetailsORM, error)
	Last() (*financial_servicev1.ReferenceDetailsORM, error)
	Find() ([]*financial_servicev1.ReferenceDetailsORM, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_servicev1.ReferenceDetailsORM, err error)
	FindInBatches(result *[]*financial_servicev1.ReferenceDetailsORM, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*financial_servicev1.ReferenceDetailsORM) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*financial_servicev1.ReferenceDetailsORM, error)
	FirstOrCreate() (*financial_servicev1.ReferenceDetailsORM, error)
	FindByPage(offset int, limit int) (result []*financial_servicev1.ReferenceDetailsORM, count int64, err error)
	...
	GetRecordByID(id int) (result financial_servicev1.ReferenceDetailsORM, err error)
	GetRecordByIDs(ids []int) (result []financial_servicev1.ReferenceDetailsORM, err error)
	CreateRecord(item financial_servicev1.ReferenceDetailsORM) (err error)
	UpdateRecordByID(id int, item financial_servicev1.ReferenceDetailsORM) (err error)
	DeleteRecordByID(id int) (err error)
	GetAllRecords(orderColumn string, limit int, offset int) (result []financial_servicev1.ReferenceDetailsORM, err error)
	CountAll() (result int, err error)
	GetByID(id uint64) (result financial_servicev1.ReferenceDetailsORM, err error)
	GetByIDs(ids []uint64) (result []financial_servicev1.ReferenceDetailsORM, err error)
}
...
//
// {{end}}
func (r referenceDetailsORMDo) GetRecordByID(id int) (result financial_servicev1.ReferenceDetailsORM, err error) {
...
//
// {{end}}
func (r referenceDetailsORMDo) GetRecordByIDs(ids []int) (result []financial_servicev1.ReferenceDetailsORM, err error) {
	var params []interface{}
...
func (r referenceDetailsORMDo) CreateRecord(item financial_servicev1.ReferenceDetailsORM) (err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (r referenceDetailsORMDo) UpdateRecordByID(id int, item financial_servicev1.ReferenceDetailsORM) (err error) {
	var params []interface{}
...
func (r referenceDetailsORMDo) GetAllRecords(orderColumn string, limit int, offset int) (result []financial_servicev1.ReferenceDetailsORM, err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (r referenceDetailsORMDo) GetByID(id uint64) (result financial_servicev1.ReferenceDetailsORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (r referenceDetailsORMDo) GetByIDs(ids []uint64) (result []financial_servicev1.ReferenceDetailsORM, err error) {
	var params []interface{}
...
func (r referenceDetailsORMDo) Create(values ...*financial_servicev1.ReferenceDetailsORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (r referenceDetailsORMDo) CreateInBatches(values []*financial_servicev1.ReferenceDetailsORM, batchSize int) error {
	return r.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (r referenceDetailsORMDo) Save(values ...*financial_servicev1.ReferenceDetailsORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (r referenceDetailsORMDo) First() (*financial_servicev1.ReferenceDetailsORM, error) {
	if result, err := r.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*financial_servicev1.ReferenceDetailsORM), nil
	}
}

func (r referenceDetailsORMDo) Take() (*financial_servicev1.ReferenceDetailsORM, error) {
...
func (r referenceDetailsORMDo) Last() (*financial_servicev1.ReferenceDetailsORM, error) {
...
func (r referenceDetailsORMDo) Find() ([]*financial_servicev1.ReferenceDetailsORM, error) {
	result, err := r.DO.Find()
	return result.([]*financial_servicev1.ReferenceDetailsORM), err
}

func (r referenceDetailsORMDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_servicev1.ReferenceDetailsORM, err error) {
	buf := make([]*financial_servicev1.ReferenceDetailsORM, 0, batchSize)
...
func (r referenceDetailsORMDo) FindInBatches(result *[]*financial_servicev1.ReferenceDetailsORM, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (r referenceDetailsORMDo) FirstOrInit() (*financial_servicev1.ReferenceDetailsORM, error) {
...
func (r referenceDetailsORMDo) FirstOrCreate() (*financial_servicev1.ReferenceDetailsORM, error) {
...
func (r referenceDetailsORMDo) FindByPage(offset int, limit int) (result []*financial_servicev1.ReferenceDetailsORM, count int64, err error) {
...
func (r referenceDetailsORMDo) Delete(models ...*financial_servicev1.ReferenceDetailsORM) (result gen.ResultInfo, err error) {
