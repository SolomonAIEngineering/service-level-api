...
func newIncomeStatementORM(db *gorm.DB, opts ...gen.DOOption) incomeStatementORM {
	...
	_incomeStatementORM.incomeStatementORMDo.UseModel(&financial_servicev1.IncomeStatementORM{})
	...
	_incomeStatementORM.CostOfSales = incomeStatementORMHasManyCostOfSales{
		...
		RelationField: field.NewRelation("CostOfSales", "financial_servicev1.ReportItemORM"),
	}

	_incomeStatementORM.Income = incomeStatementORMHasManyIncome{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("Income", "financial_servicev1.ReportItemORM"),
	}

	_incomeStatementORM.NonOperatingExpenses = incomeStatementORMHasManyNonOperatingExpenses{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("NonOperatingExpenses", "financial_servicev1.ReportItemORM"),
	}

	_incomeStatementORM.OperatingExpenses = incomeStatementORMHasManyOperatingExpenses{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("OperatingExpenses", "financial_servicev1.ReportItemORM"),
	}
...
func (a incomeStatementORMHasManyCostOfSales) Model(m *financial_servicev1.IncomeStatementORM) *incomeStatementORMHasManyCostOfSalesTx {
...
func (a incomeStatementORMHasManyCostOfSalesTx) Find() (result []*financial_servicev1.ReportItemORM, err error) {
	return result, a.tx.Find(&result)
}

func (a incomeStatementORMHasManyCostOfSalesTx) Append(values ...*financial_servicev1.ReportItemORM) (err error) {
...
func (a incomeStatementORMHasManyCostOfSalesTx) Replace(values ...*financial_servicev1.ReportItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a incomeStatementORMHasManyCostOfSalesTx) Delete(values ...*financial_servicev1.ReportItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a incomeStatementORMHasManyIncome) Model(m *financial_servicev1.IncomeStatementORM) *incomeStatementORMHasManyIncomeTx {
...
func (a incomeStatementORMHasManyIncomeTx) Find() (result []*financial_servicev1.ReportItemORM, err error) {
	return result, a.tx.Find(&result)
}

func (a incomeStatementORMHasManyIncomeTx) Append(values ...*financial_servicev1.ReportItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a incomeStatementORMHasManyIncomeTx) Replace(values ...*financial_servicev1.ReportItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a incomeStatementORMHasManyIncomeTx) Delete(values ...*financial_servicev1.ReportItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a incomeStatementORMHasManyNonOperatingExpenses) Model(m *financial_servicev1.IncomeStatementORM) *incomeStatementORMHasManyNonOperatingExpensesTx {
...
func (a incomeStatementORMHasManyNonOperatingExpensesTx) Find() (result []*financial_servicev1.ReportItemORM, err error) {
	return result, a.tx.Find(&result)
}

func (a incomeStatementORMHasManyNonOperatingExpensesTx) Append(values ...*financial_servicev1.ReportItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a incomeStatementORMHasManyNonOperatingExpensesTx) Replace(values ...*financial_servicev1.ReportItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a incomeStatementORMHasManyNonOperatingExpensesTx) Delete(values ...*financial_servicev1.ReportItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a incomeStatementORMHasManyOperatingExpenses) Model(m *financial_servicev1.IncomeStatementORM) *incomeStatementORMHasManyOperatingExpensesTx {
...
func (a incomeStatementORMHasManyOperatingExpensesTx) Find() (result []*financial_servicev1.ReportItemORM, err error) {
	return result, a.tx.Find(&result)
}

func (a incomeStatementORMHasManyOperatingExpensesTx) Append(values ...*financial_servicev1.ReportItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a incomeStatementORMHasManyOperatingExpensesTx) Replace(values ...*financial_servicev1.ReportItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a incomeStatementORMHasManyOperatingExpensesTx) Delete(values ...*financial_servicev1.ReportItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type IIncomeStatementORMDo interface {
	...
	Create(values ...*financial_servicev1.IncomeStatementORM) error
	CreateInBatches(values []*financial_servicev1.IncomeStatementORM, batchSize int) error
	Save(values ...*financial_servicev1.IncomeStatementORM) error
	First() (*financial_servicev1.IncomeStatementORM, error)
	Take() (*financial_servicev1.IncomeStatementORM, error)
	Last() (*financial_servicev1.IncomeStatementORM, error)
	Find() ([]*financial_servicev1.IncomeStatementORM, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_servicev1.IncomeStatementORM, err error)
	FindInBatches(result *[]*financial_servicev1.IncomeStatementORM, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*financial_servicev1.IncomeStatementORM) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*financial_servicev1.IncomeStatementORM, error)
	FirstOrCreate() (*financial_servicev1.IncomeStatementORM, error)
	FindByPage(offset int, limit int) (result []*financial_servicev1.IncomeStatementORM, count int64, err error)
	...
	GetRecordByID(id int) (result financial_servicev1.IncomeStatementORM, err error)
	GetRecordByIDs(ids []int) (result []financial_servicev1.IncomeStatementORM, err error)
	CreateRecord(item financial_servicev1.IncomeStatementORM) (err error)
	UpdateRecordByID(id int, item financial_servicev1.IncomeStatementORM) (err error)
	DeleteRecordByID(id int) (err error)
	GetAllRecords(orderColumn string, limit int, offset int) (result []financial_servicev1.IncomeStatementORM, err error)
	CountAll() (result int, err error)
	GetByID(id uint64) (result financial_servicev1.IncomeStatementORM, err error)
	GetByIDs(ids []uint64) (result []financial_servicev1.IncomeStatementORM, err error)
}
...
//
// {{end}}
func (i incomeStatementORMDo) GetRecordByID(id int) (result financial_servicev1.IncomeStatementORM, err error) {
...
//
// {{end}}
func (i incomeStatementORMDo) GetRecordByIDs(ids []int) (result []financial_servicev1.IncomeStatementORM, err error) {
	var params []interface{}
...
func (i incomeStatementORMDo) CreateRecord(item financial_servicev1.IncomeStatementORM) (err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (i incomeStatementORMDo) UpdateRecordByID(id int, item financial_servicev1.IncomeStatementORM) (err error) {
	var params []interface{}
...
func (i incomeStatementORMDo) GetAllRecords(orderColumn string, limit int, offset int) (result []financial_servicev1.IncomeStatementORM, err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (i incomeStatementORMDo) GetByID(id uint64) (result financial_servicev1.IncomeStatementORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (i incomeStatementORMDo) GetByIDs(ids []uint64) (result []financial_servicev1.IncomeStatementORM, err error) {
	var params []interface{}
...
func (i incomeStatementORMDo) Create(values ...*financial_servicev1.IncomeStatementORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (i incomeStatementORMDo) CreateInBatches(values []*financial_servicev1.IncomeStatementORM, batchSize int) error {
	return i.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (i incomeStatementORMDo) Save(values ...*financial_servicev1.IncomeStatementORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (i incomeStatementORMDo) First() (*financial_servicev1.IncomeStatementORM, error) {
	if result, err := i.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*financial_servicev1.IncomeStatementORM), nil
	}
}

func (i incomeStatementORMDo) Take() (*financial_servicev1.IncomeStatementORM, error) {
...
func (i incomeStatementORMDo) Last() (*financial_servicev1.IncomeStatementORM, error) {
...
func (i incomeStatementORMDo) Find() ([]*financial_servicev1.IncomeStatementORM, error) {
	result, err := i.DO.Find()
	return result.([]*financial_servicev1.IncomeStatementORM), err
}

func (i incomeStatementORMDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_servicev1.IncomeStatementORM, err error) {
	buf := make([]*financial_servicev1.IncomeStatementORM, 0, batchSize)
...
func (i incomeStatementORMDo) FindInBatches(result *[]*financial_servicev1.IncomeStatementORM, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (i incomeStatementORMDo) FirstOrInit() (*financial_servicev1.IncomeStatementORM, error) {
...
func (i incomeStatementORMDo) FirstOrCreate() (*financial_servicev1.IncomeStatementORM, error) {
...
func (i incomeStatementORMDo) FindByPage(offset int, limit int) (result []*financial_servicev1.IncomeStatementORM, count int64, err error) {
...
func (i incomeStatementORMDo) Delete(models ...*financial_servicev1.IncomeStatementORM) (result gen.ResultInfo, err error) {
