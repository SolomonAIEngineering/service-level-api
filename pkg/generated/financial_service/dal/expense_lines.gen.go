...
func newExpenseLineORM(db *gorm.DB, opts ...gen.DOOption) expenseLineORM {
	...
	_expenseLineORM.expenseLineORMDo.UseModel(&financial_servicev1.ExpenseLineORM{})
...
type IExpenseLineORMDo interface {
	...
	Create(values ...*financial_servicev1.ExpenseLineORM) error
	CreateInBatches(values []*financial_servicev1.ExpenseLineORM, batchSize int) error
	Save(values ...*financial_servicev1.ExpenseLineORM) error
	First() (*financial_servicev1.ExpenseLineORM, error)
	Take() (*financial_servicev1.ExpenseLineORM, error)
	Last() (*financial_servicev1.ExpenseLineORM, error)
	Find() ([]*financial_servicev1.ExpenseLineORM, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_servicev1.ExpenseLineORM, err error)
	FindInBatches(result *[]*financial_servicev1.ExpenseLineORM, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*financial_servicev1.ExpenseLineORM) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*financial_servicev1.ExpenseLineORM, error)
	FirstOrCreate() (*financial_servicev1.ExpenseLineORM, error)
	FindByPage(offset int, limit int) (result []*financial_servicev1.ExpenseLineORM, count int64, err error)
	...
	GetRecordByID(id int) (result financial_servicev1.ExpenseLineORM, err error)
	GetRecordByIDs(ids []int) (result []financial_servicev1.ExpenseLineORM, err error)
	CreateRecord(item financial_servicev1.ExpenseLineORM) (err error)
	UpdateRecordByID(id int, item financial_servicev1.ExpenseLineORM) (err error)
	DeleteRecordByID(id int) (err error)
	GetAllRecords(orderColumn string, limit int, offset int) (result []financial_servicev1.ExpenseLineORM, err error)
	CountAll() (result int, err error)
	GetByID(id uint64) (result financial_servicev1.ExpenseLineORM, err error)
	GetByIDs(ids []uint64) (result []financial_servicev1.ExpenseLineORM, err error)
}
...
//
// {{end}}
func (e expenseLineORMDo) GetRecordByID(id int) (result financial_servicev1.ExpenseLineORM, err error) {
...
//
// {{end}}
func (e expenseLineORMDo) GetRecordByIDs(ids []int) (result []financial_servicev1.ExpenseLineORM, err error) {
	var params []interface{}
...
func (e expenseLineORMDo) CreateRecord(item financial_servicev1.ExpenseLineORM) (err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (e expenseLineORMDo) UpdateRecordByID(id int, item financial_servicev1.ExpenseLineORM) (err error) {
	var params []interface{}
...
func (e expenseLineORMDo) GetAllRecords(orderColumn string, limit int, offset int) (result []financial_servicev1.ExpenseLineORM, err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (e expenseLineORMDo) GetByID(id uint64) (result financial_servicev1.ExpenseLineORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (e expenseLineORMDo) GetByIDs(ids []uint64) (result []financial_servicev1.ExpenseLineORM, err error) {
	var params []interface{}
...
func (e expenseLineORMDo) Create(values ...*financial_servicev1.ExpenseLineORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (e expenseLineORMDo) CreateInBatches(values []*financial_servicev1.ExpenseLineORM, batchSize int) error {
	return e.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (e expenseLineORMDo) Save(values ...*financial_servicev1.ExpenseLineORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (e expenseLineORMDo) First() (*financial_servicev1.ExpenseLineORM, error) {
	if result, err := e.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*financial_servicev1.ExpenseLineORM), nil
	}
}

func (e expenseLineORMDo) Take() (*financial_servicev1.ExpenseLineORM, error) {
...
func (e expenseLineORMDo) Last() (*financial_servicev1.ExpenseLineORM, error) {
...
func (e expenseLineORMDo) Find() ([]*financial_servicev1.ExpenseLineORM, error) {
	result, err := e.DO.Find()
	return result.([]*financial_servicev1.ExpenseLineORM), err
}

func (e expenseLineORMDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_servicev1.ExpenseLineORM, err error) {
	buf := make([]*financial_servicev1.ExpenseLineORM, 0, batchSize)
...
func (e expenseLineORMDo) FindInBatches(result *[]*financial_servicev1.ExpenseLineORM, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (e expenseLineORMDo) FirstOrInit() (*financial_servicev1.ExpenseLineORM, error) {
...
func (e expenseLineORMDo) FirstOrCreate() (*financial_servicev1.ExpenseLineORM, error) {
...
func (e expenseLineORMDo) FindByPage(offset int, limit int) (result []*financial_servicev1.ExpenseLineORM, count int64, err error) {
...
func (e expenseLineORMDo) Delete(models ...*financial_servicev1.ExpenseLineORM) (result gen.ResultInfo, err error) {
