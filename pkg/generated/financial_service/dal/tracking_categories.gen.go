...
func newTrackingCategoryORM(db *gorm.DB, opts ...gen.DOOption) trackingCategoryORM {
	...
	_trackingCategoryORM.trackingCategoryORMDo.UseModel(&financial_servicev1.TrackingCategoryORM{})
...
type ITrackingCategoryORMDo interface {
	...
	Create(values ...*financial_servicev1.TrackingCategoryORM) error
	CreateInBatches(values []*financial_servicev1.TrackingCategoryORM, batchSize int) error
	Save(values ...*financial_servicev1.TrackingCategoryORM) error
	First() (*financial_servicev1.TrackingCategoryORM, error)
	Take() (*financial_servicev1.TrackingCategoryORM, error)
	Last() (*financial_servicev1.TrackingCategoryORM, error)
	Find() ([]*financial_servicev1.TrackingCategoryORM, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_servicev1.TrackingCategoryORM, err error)
	FindInBatches(result *[]*financial_servicev1.TrackingCategoryORM, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*financial_servicev1.TrackingCategoryORM) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*financial_servicev1.TrackingCategoryORM, error)
	FirstOrCreate() (*financial_servicev1.TrackingCategoryORM, error)
	FindByPage(offset int, limit int) (result []*financial_servicev1.TrackingCategoryORM, count int64, err error)
	...
	GetRecordByID(id int) (result financial_servicev1.TrackingCategoryORM, err error)
	GetRecordByIDs(ids []int) (result []financial_servicev1.TrackingCategoryORM, err error)
	CreateRecord(item financial_servicev1.TrackingCategoryORM) (err error)
	UpdateRecordByID(id int, item financial_servicev1.TrackingCategoryORM) (err error)
	DeleteRecordByID(id int) (err error)
	GetAllRecords(orderColumn string, limit int, offset int) (result []financial_servicev1.TrackingCategoryORM, err error)
	CountAll() (result int, err error)
	GetByID(id uint64) (result financial_servicev1.TrackingCategoryORM, err error)
	GetByIDs(ids []uint64) (result []financial_servicev1.TrackingCategoryORM, err error)
}
...
//
// {{end}}
func (t trackingCategoryORMDo) GetRecordByID(id int) (result financial_servicev1.TrackingCategoryORM, err error) {
...
//
// {{end}}
func (t trackingCategoryORMDo) GetRecordByIDs(ids []int) (result []financial_servicev1.TrackingCategoryORM, err error) {
	var params []interface{}
...
func (t trackingCategoryORMDo) CreateRecord(item financial_servicev1.TrackingCategoryORM) (err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (t trackingCategoryORMDo) UpdateRecordByID(id int, item financial_servicev1.TrackingCategoryORM) (err error) {
	var params []interface{}
...
func (t trackingCategoryORMDo) GetAllRecords(orderColumn string, limit int, offset int) (result []financial_servicev1.TrackingCategoryORM, err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (t trackingCategoryORMDo) GetByID(id uint64) (result financial_servicev1.TrackingCategoryORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (t trackingCategoryORMDo) GetByIDs(ids []uint64) (result []financial_servicev1.TrackingCategoryORM, err error) {
	var params []interface{}
...
func (t trackingCategoryORMDo) Create(values ...*financial_servicev1.TrackingCategoryORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (t trackingCategoryORMDo) CreateInBatches(values []*financial_servicev1.TrackingCategoryORM, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t trackingCategoryORMDo) Save(values ...*financial_servicev1.TrackingCategoryORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (t trackingCategoryORMDo) First() (*financial_servicev1.TrackingCategoryORM, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*financial_servicev1.TrackingCategoryORM), nil
	}
}

func (t trackingCategoryORMDo) Take() (*financial_servicev1.TrackingCategoryORM, error) {
...
func (t trackingCategoryORMDo) Last() (*financial_servicev1.TrackingCategoryORM, error) {
...
func (t trackingCategoryORMDo) Find() ([]*financial_servicev1.TrackingCategoryORM, error) {
	result, err := t.DO.Find()
	return result.([]*financial_servicev1.TrackingCategoryORM), err
}

func (t trackingCategoryORMDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_servicev1.TrackingCategoryORM, err error) {
	buf := make([]*financial_servicev1.TrackingCategoryORM, 0, batchSize)
...
func (t trackingCategoryORMDo) FindInBatches(result *[]*financial_servicev1.TrackingCategoryORM, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t trackingCategoryORMDo) FirstOrInit() (*financial_servicev1.TrackingCategoryORM, error) {
...
func (t trackingCategoryORMDo) FirstOrCreate() (*financial_servicev1.TrackingCategoryORM, error) {
...
func (t trackingCategoryORMDo) FindByPage(offset int, limit int) (result []*financial_servicev1.TrackingCategoryORM, count int64, err error) {
...
func (t trackingCategoryORMDo) Delete(models ...*financial_servicev1.TrackingCategoryORM) (result gen.ResultInfo, err error) {
