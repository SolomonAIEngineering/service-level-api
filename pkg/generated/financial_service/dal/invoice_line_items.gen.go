...
type IInvoiceLineItemORMDo interface {
	...
	GetByID(id uint64) (result financial_servicev1.InvoiceLineItemORM, err error)
	GetByIDs(ids []uint64) (result []financial_servicev1.InvoiceLineItemORM, err error)
}
...
//
// {{end}}
func (i invoiceLineItemORMDo) GetByID(id uint64) (result financial_servicev1.InvoiceLineItemORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (i invoiceLineItemORMDo) GetByIDs(ids []uint64) (result []financial_servicev1.InvoiceLineItemORM, err error) {
	var params []interface{}
