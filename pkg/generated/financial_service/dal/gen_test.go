...
func Test_WithContext(t *testing.T) {
	...
	for _, ctx := range []context.Context{
		...
		qCtx.CashFlowStatementsORM.UnderlyingDB().Statement.Context,
		...
		qCtx.ReferenceDetailsORM.UnderlyingDB().Statement.Context,
		qCtx.ReportDetailsORM.UnderlyingDB().Statement.Context,
