...
type ITransactionLineItemORMDo interface {
	...
	GetByID(id uint64) (result financial_servicev1.TransactionLineItemORM, err error)
	GetByIDs(ids []uint64) (result []financial_servicev1.TransactionLineItemORM, err error)
}
...
//
// {{end}}
func (t transactionLineItemORMDo) GetByID(id uint64) (result financial_servicev1.TransactionLineItemORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (t transactionLineItemORMDo) GetByIDs(ids []uint64) (result []financial_servicev1.TransactionLineItemORM, err error) {
	var params []interface{}
