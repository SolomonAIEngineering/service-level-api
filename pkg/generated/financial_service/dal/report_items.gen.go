...
func newReportItemORM(db *gorm.DB, opts ...gen.DOOption) reportItemORM {
	...
	_reportItemORM.reportItemORMDo.UseModel(&financial_servicev1.ReportItemORM{})
...
type IReportItemORMDo interface {
	...
	Create(values ...*financial_servicev1.ReportItemORM) error
	CreateInBatches(values []*financial_servicev1.ReportItemORM, batchSize int) error
	Save(values ...*financial_servicev1.ReportItemORM) error
	First() (*financial_servicev1.ReportItemORM, error)
	Take() (*financial_servicev1.ReportItemORM, error)
	Last() (*financial_servicev1.ReportItemORM, error)
	Find() ([]*financial_servicev1.ReportItemORM, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_servicev1.ReportItemORM, err error)
	FindInBatches(result *[]*financial_servicev1.ReportItemORM, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*financial_servicev1.ReportItemORM) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*financial_servicev1.ReportItemORM, error)
	FirstOrCreate() (*financial_servicev1.ReportItemORM, error)
	FindByPage(offset int, limit int) (result []*financial_servicev1.ReportItemORM, count int64, err error)
	...
	GetRecordByID(id int) (result financial_servicev1.ReportItemORM, err error)
	GetRecordByIDs(ids []int) (result []financial_servicev1.ReportItemORM, err error)
	CreateRecord(item financial_servicev1.ReportItemORM) (err error)
	UpdateRecordByID(id int, item financial_servicev1.ReportItemORM) (err error)
	DeleteRecordByID(id int) (err error)
	GetAllRecords(orderColumn string, limit int, offset int) (result []financial_servicev1.ReportItemORM, err error)
	CountAll() (result int, err error)
	GetByID(id uint64) (result financial_servicev1.ReportItemORM, err error)
	GetByIDs(ids []uint64) (result []financial_servicev1.ReportItemORM, err error)
}
...
//
// {{end}}
func (r reportItemORMDo) GetRecordByID(id int) (result financial_servicev1.ReportItemORM, err error) {
...
//
// {{end}}
func (r reportItemORMDo) GetRecordByIDs(ids []int) (result []financial_servicev1.ReportItemORM, err error) {
	var params []interface{}
...
func (r reportItemORMDo) CreateRecord(item financial_servicev1.ReportItemORM) (err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (r reportItemORMDo) UpdateRecordByID(id int, item financial_servicev1.ReportItemORM) (err error) {
	var params []interface{}
...
func (r reportItemORMDo) GetAllRecords(orderColumn string, limit int, offset int) (result []financial_servicev1.ReportItemORM, err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (r reportItemORMDo) GetByID(id uint64) (result financial_servicev1.ReportItemORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (r reportItemORMDo) GetByIDs(ids []uint64) (result []financial_servicev1.ReportItemORM, err error) {
	var params []interface{}
...
func (r reportItemORMDo) Create(values ...*financial_servicev1.ReportItemORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (r reportItemORMDo) CreateInBatches(values []*financial_servicev1.ReportItemORM, batchSize int) error {
	return r.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (r reportItemORMDo) Save(values ...*financial_servicev1.ReportItemORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (r reportItemORMDo) First() (*financial_servicev1.ReportItemORM, error) {
	if result, err := r.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*financial_servicev1.ReportItemORM), nil
	}
}

func (r reportItemORMDo) Take() (*financial_servicev1.ReportItemORM, error) {
...
func (r reportItemORMDo) Last() (*financial_servicev1.ReportItemORM, error) {
...
func (r reportItemORMDo) Find() ([]*financial_servicev1.ReportItemORM, error) {
	result, err := r.DO.Find()
	return result.([]*financial_servicev1.ReportItemORM), err
}

func (r reportItemORMDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_servicev1.ReportItemORM, err error) {
	buf := make([]*financial_servicev1.ReportItemORM, 0, batchSize)
...
func (r reportItemORMDo) FindInBatches(result *[]*financial_servicev1.ReportItemORM, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (r reportItemORMDo) FirstOrInit() (*financial_servicev1.ReportItemORM, error) {
...
func (r reportItemORMDo) FirstOrCreate() (*financial_servicev1.ReportItemORM, error) {
...
func (r reportItemORMDo) FindByPage(offset int, limit int) (result []*financial_servicev1.ReportItemORM, count int64, err error) {
...
func (r reportItemORMDo) Delete(models ...*financial_servicev1.ReportItemORM) (result gen.ResultInfo, err error) {
