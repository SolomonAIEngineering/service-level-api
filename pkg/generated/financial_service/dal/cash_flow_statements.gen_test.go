...
func init() {
	InitializeDB()
	err := db.AutoMigrate(&financial_servicev1.CashFlowStatementsORM{})
	if err != nil {
		fmt.Printf("Error: AutoMigrate(&financial_servicev1.CashFlowStatementsORM{}) fail: %s", err)
	}
}
...
func Test_cashFlowStatementsORMQuery(t *testing.T) {
	...
	err = _do.Create(&financial_servicev1.CashFlowStatementsORM{})
	if err != nil {
		t.Error("create item in table <cash_flow_statements> fail:", err)
	}

	err = _do.Save(&financial_servicev1.CashFlowStatementsORM{})
	if err != nil {
		t.Error("create item in table <cash_flow_statements> fail:", err)
	}

	err = _do.CreateInBatches([]*financial_servicev1.CashFlowStatementsORM{{}, {}}, 10)
	if err != nil {
		t.Error("create item in table <cash_flow_statements> fail:", err)
	}
	...
	err = _do.Where(primaryKey.IsNotNull()).FindInBatches(&[]*financial_servicev1.CashFlowStatementsORM{}, 10, func(tx gen.Dao, batch int) error { return nil })
	if err != nil {
	...
	_, err = _do.ScanByPage(&financial_servicev1.CashFlowStatementsORM{}, 0, 1)
	if err != nil {
...
func Test_cashFlowStatementsORM_CreateRecord(t *testing.T) {
	...
	for i, tt := range CashFlowStatementsORMCreateRecordTestCase {
		t.Run("CreateRecord_"+strconv.Itoa(i), func(t *testing.T) {
			res1 := do.CreateRecord(tt.Input.Args[0].(financial_servicev1.CashFlowStatementsORM))
...
func Test_cashFlowStatementsORM_UpdateRecordByID(t *testing.T) {
	...
	for i, tt := range CashFlowStatementsORMUpdateRecordByIDTestCase {
		t.Run("UpdateRecordByID_"+strconv.Itoa(i), func(t *testing.T) {
			res1 := do.UpdateRecordByID(tt.Input.Args[0].(int), tt.Input.Args[1].(financial_servicev1.CashFlowStatementsORM))
