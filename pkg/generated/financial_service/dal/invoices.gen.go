...
type IInvoiceORMDo interface {
	...
	GetByID(id uint64) (result financial_servicev1.InvoiceORM, err error)
	GetByIDs(ids []uint64) (result []financial_servicev1.InvoiceORM, err error)
}
...
//
// {{end}}
func (i invoiceORMDo) GetByID(id uint64) (result financial_servicev1.InvoiceORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (i invoiceORMDo) GetByIDs(ids []uint64) (result []financial_servicev1.InvoiceORM, err error) {
	var params []interface{}
