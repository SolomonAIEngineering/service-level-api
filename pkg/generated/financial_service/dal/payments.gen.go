...
type IPaymentORMDo interface {
	...
	GetByID(id uint64) (result financial_servicev1.PaymentORM, err error)
	GetByIDs(ids []uint64) (result []financial_servicev1.PaymentORM, err error)
}
...
//
// {{end}}
func (p paymentORMDo) GetByID(id uint64) (result financial_servicev1.PaymentORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (p paymentORMDo) GetByIDs(ids []uint64) (result []financial_servicev1.PaymentORM, err error) {
	var params []interface{}
