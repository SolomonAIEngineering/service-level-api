...
type IBusinessChartOfAccountsORMDo interface {
	...
	GetByID(id uint64) (result financial_servicev1.BusinessChartOfAccountsORM, err error)
	GetByIDs(ids []uint64) (result []financial_servicev1.BusinessChartOfAccountsORM, err error)
}
...
//
// {{end}}
func (b businessChartOfAccountsORMDo) GetByID(id uint64) (result financial_servicev1.BusinessChartOfAccountsORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (b businessChartOfAccountsORMDo) GetByIDs(ids []uint64) (result []financial_servicev1.BusinessChartOfAccountsORM, err error) {
	var params []interface{}
