...
func newContactsORM(db *gorm.DB, opts ...gen.DOOption) contactsORM {
	...
	_contactsORM.contactsORMDo.UseModel(&financial_servicev1.ContactsORM{})
...
type IContactsORMDo interface {
	...
	Create(values ...*financial_servicev1.ContactsORM) error
	CreateInBatches(values []*financial_servicev1.ContactsORM, batchSize int) error
	Save(values ...*financial_servicev1.ContactsORM) error
	First() (*financial_servicev1.ContactsORM, error)
	Take() (*financial_servicev1.ContactsORM, error)
	Last() (*financial_servicev1.ContactsORM, error)
	Find() ([]*financial_servicev1.ContactsORM, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_servicev1.ContactsORM, err error)
	FindInBatches(result *[]*financial_servicev1.ContactsORM, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*financial_servicev1.ContactsORM) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*financial_servicev1.ContactsORM, error)
	FirstOrCreate() (*financial_servicev1.ContactsORM, error)
	FindByPage(offset int, limit int) (result []*financial_servicev1.ContactsORM, count int64, err error)
	...
	GetRecordByID(id int) (result financial_servicev1.ContactsORM, err error)
	GetRecordByIDs(ids []int) (result []financial_servicev1.ContactsORM, err error)
	CreateRecord(item financial_servicev1.ContactsORM) (err error)
	UpdateRecordByID(id int, item financial_servicev1.ContactsORM) (err error)
	DeleteRecordByID(id int) (err error)
	GetAllRecords(orderColumn string, limit int, offset int) (result []financial_servicev1.ContactsORM, err error)
	CountAll() (result int, err error)
	GetByID(id uint64) (result financial_servicev1.ContactsORM, err error)
	GetByIDs(ids []uint64) (result []financial_servicev1.ContactsORM, err error)
}
...
//
// {{end}}
func (c contactsORMDo) GetRecordByID(id int) (result financial_servicev1.ContactsORM, err error) {
...
//
// {{end}}
func (c contactsORMDo) GetRecordByIDs(ids []int) (result []financial_servicev1.ContactsORM, err error) {
	var params []interface{}
...
func (c contactsORMDo) CreateRecord(item financial_servicev1.ContactsORM) (err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (c contactsORMDo) UpdateRecordByID(id int, item financial_servicev1.ContactsORM) (err error) {
	var params []interface{}
...
func (c contactsORMDo) GetAllRecords(orderColumn string, limit int, offset int) (result []financial_servicev1.ContactsORM, err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (c contactsORMDo) GetByID(id uint64) (result financial_servicev1.ContactsORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (c contactsORMDo) GetByIDs(ids []uint64) (result []financial_servicev1.ContactsORM, err error) {
	var params []interface{}
...
func (c contactsORMDo) Create(values ...*financial_servicev1.ContactsORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (c contactsORMDo) CreateInBatches(values []*financial_servicev1.ContactsORM, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c contactsORMDo) Save(values ...*financial_servicev1.ContactsORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (c contactsORMDo) First() (*financial_servicev1.ContactsORM, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*financial_servicev1.ContactsORM), nil
	}
}

func (c contactsORMDo) Take() (*financial_servicev1.ContactsORM, error) {
...
func (c contactsORMDo) Last() (*financial_servicev1.ContactsORM, error) {
...
func (c contactsORMDo) Find() ([]*financial_servicev1.ContactsORM, error) {
	result, err := c.DO.Find()
	return result.([]*financial_servicev1.ContactsORM), err
}

func (c contactsORMDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_servicev1.ContactsORM, err error) {
	buf := make([]*financial_servicev1.ContactsORM, 0, batchSize)
...
func (c contactsORMDo) FindInBatches(result *[]*financial_servicev1.ContactsORM, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c contactsORMDo) FirstOrInit() (*financial_servicev1.ContactsORM, error) {
...
func (c contactsORMDo) FirstOrCreate() (*financial_servicev1.ContactsORM, error) {
...
func (c contactsORMDo) FindByPage(offset int, limit int) (result []*financial_servicev1.ContactsORM, count int64, err error) {
...
func (c contactsORMDo) Delete(models ...*financial_servicev1.ContactsORM) (result gen.ResultInfo, err error) {
