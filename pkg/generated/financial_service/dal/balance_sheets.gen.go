...
func newBalanceSheetORM(db *gorm.DB, opts ...gen.DOOption) balanceSheetORM {
	...
	_balanceSheetORM.balanceSheetORMDo.UseModel(&financial_servicev1.BalanceSheetORM{})
	...
	_balanceSheetORM.Assets = balanceSheetORMHasManyAssets{
		...
		RelationField: field.NewRelation("Assets", "financial_servicev1.ReportItemORM"),
	}

	_balanceSheetORM.Equity = balanceSheetORMHasManyEquity{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("Equity", "financial_servicev1.ReportItemORM"),
	}

	_balanceSheetORM.Liabilities = balanceSheetORMHasManyLiabilities{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("Liabilities", "financial_servicev1.ReportItemORM"),
	}
...
func (a balanceSheetORMHasManyAssets) Model(m *financial_servicev1.BalanceSheetORM) *balanceSheetORMHasManyAssetsTx {
...
func (a balanceSheetORMHasManyAssetsTx) Find() (result []*financial_servicev1.ReportItemORM, err error) {
	return result, a.tx.Find(&result)
}

func (a balanceSheetORMHasManyAssetsTx) Append(values ...*financial_servicev1.ReportItemORM) (err error) {
...
func (a balanceSheetORMHasManyAssetsTx) Replace(values ...*financial_servicev1.ReportItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a balanceSheetORMHasManyAssetsTx) Delete(values ...*financial_servicev1.ReportItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a balanceSheetORMHasManyEquity) Model(m *financial_servicev1.BalanceSheetORM) *balanceSheetORMHasManyEquityTx {
...
func (a balanceSheetORMHasManyEquityTx) Find() (result []*financial_servicev1.ReportItemORM, err error) {
	return result, a.tx.Find(&result)
}

func (a balanceSheetORMHasManyEquityTx) Append(values ...*financial_servicev1.ReportItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a balanceSheetORMHasManyEquityTx) Replace(values ...*financial_servicev1.ReportItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a balanceSheetORMHasManyEquityTx) Delete(values ...*financial_servicev1.ReportItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a balanceSheetORMHasManyLiabilities) Model(m *financial_servicev1.BalanceSheetORM) *balanceSheetORMHasManyLiabilitiesTx {
...
func (a balanceSheetORMHasManyLiabilitiesTx) Find() (result []*financial_servicev1.ReportItemORM, err error) {
	return result, a.tx.Find(&result)
}

func (a balanceSheetORMHasManyLiabilitiesTx) Append(values ...*financial_servicev1.ReportItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a balanceSheetORMHasManyLiabilitiesTx) Replace(values ...*financial_servicev1.ReportItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a balanceSheetORMHasManyLiabilitiesTx) Delete(values ...*financial_servicev1.ReportItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type IBalanceSheetORMDo interface {
	...
	Create(values ...*financial_servicev1.BalanceSheetORM) error
	CreateInBatches(values []*financial_servicev1.BalanceSheetORM, batchSize int) error
	Save(values ...*financial_servicev1.BalanceSheetORM) error
	First() (*financial_servicev1.BalanceSheetORM, error)
	Take() (*financial_servicev1.BalanceSheetORM, error)
	Last() (*financial_servicev1.BalanceSheetORM, error)
	Find() ([]*financial_servicev1.BalanceSheetORM, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_servicev1.BalanceSheetORM, err error)
	FindInBatches(result *[]*financial_servicev1.BalanceSheetORM, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*financial_servicev1.BalanceSheetORM) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*financial_servicev1.BalanceSheetORM, error)
	FirstOrCreate() (*financial_servicev1.BalanceSheetORM, error)
	FindByPage(offset int, limit int) (result []*financial_servicev1.BalanceSheetORM, count int64, err error)
	...
	GetRecordByID(id int) (result financial_servicev1.BalanceSheetORM, err error)
	GetRecordByIDs(ids []int) (result []financial_servicev1.BalanceSheetORM, err error)
	CreateRecord(item financial_servicev1.BalanceSheetORM) (err error)
	UpdateRecordByID(id int, item financial_servicev1.BalanceSheetORM) (err error)
	DeleteRecordByID(id int) (err error)
	GetAllRecords(orderColumn string, limit int, offset int) (result []financial_servicev1.BalanceSheetORM, err error)
	CountAll() (result int, err error)
	GetByID(id uint64) (result financial_servicev1.BalanceSheetORM, err error)
	GetByIDs(ids []uint64) (result []financial_servicev1.BalanceSheetORM, err error)
}
...
//
// {{end}}
func (b balanceSheetORMDo) GetRecordByID(id int) (result financial_servicev1.BalanceSheetORM, err error) {
...
//
// {{end}}
func (b balanceSheetORMDo) GetRecordByIDs(ids []int) (result []financial_servicev1.BalanceSheetORM, err error) {
	var params []interface{}
...
func (b balanceSheetORMDo) CreateRecord(item financial_servicev1.BalanceSheetORM) (err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (b balanceSheetORMDo) UpdateRecordByID(id int, item financial_servicev1.BalanceSheetORM) (err error) {
	var params []interface{}
...
func (b balanceSheetORMDo) GetAllRecords(orderColumn string, limit int, offset int) (result []financial_servicev1.BalanceSheetORM, err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (b balanceSheetORMDo) GetByID(id uint64) (result financial_servicev1.BalanceSheetORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (b balanceSheetORMDo) GetByIDs(ids []uint64) (result []financial_servicev1.BalanceSheetORM, err error) {
	var params []interface{}
...
func (b balanceSheetORMDo) Create(values ...*financial_servicev1.BalanceSheetORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (b balanceSheetORMDo) CreateInBatches(values []*financial_servicev1.BalanceSheetORM, batchSize int) error {
	return b.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (b balanceSheetORMDo) Save(values ...*financial_servicev1.BalanceSheetORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (b balanceSheetORMDo) First() (*financial_servicev1.BalanceSheetORM, error) {
	if result, err := b.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*financial_servicev1.BalanceSheetORM), nil
	}
}

func (b balanceSheetORMDo) Take() (*financial_servicev1.BalanceSheetORM, error) {
...
func (b balanceSheetORMDo) Last() (*financial_servicev1.BalanceSheetORM, error) {
...
func (b balanceSheetORMDo) Find() ([]*financial_servicev1.BalanceSheetORM, error) {
	result, err := b.DO.Find()
	return result.([]*financial_servicev1.BalanceSheetORM), err
}

func (b balanceSheetORMDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_servicev1.BalanceSheetORM, err error) {
	buf := make([]*financial_servicev1.BalanceSheetORM, 0, batchSize)
...
func (b balanceSheetORMDo) FindInBatches(result *[]*financial_servicev1.BalanceSheetORM, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (b balanceSheetORMDo) FirstOrInit() (*financial_servicev1.BalanceSheetORM, error) {
...
func (b balanceSheetORMDo) FirstOrCreate() (*financial_servicev1.BalanceSheetORM, error) {
...
func (b balanceSheetORMDo) FindByPage(offset int, limit int) (result []*financial_servicev1.BalanceSheetORM, count int64, err error) {
...
func (b balanceSheetORMDo) Delete(models ...*financial_servicev1.BalanceSheetORM) (result gen.ResultInfo, err error) {
