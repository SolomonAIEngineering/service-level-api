...
type ICompanyInfoORMDo interface {
	...
	GetByID(id uint64) (result financial_servicev1.CompanyInfoORM, err error)
	GetByIDs(ids []uint64) (result []financial_servicev1.CompanyInfoORM, err error)
}
...
//
// {{end}}
func (c companyInfoORMDo) GetByID(id uint64) (result financial_servicev1.CompanyInfoORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (c companyInfoORMDo) GetByIDs(ids []uint64) (result []financial_servicev1.CompanyInfoORM, err error) {
	var params []interface{}
