...
type IAccountingAttachmentORMDo interface {
	...
	GetByID(id uint64) (result financial_servicev1.AccountingAttachmentORM, err error)
	GetByIDs(ids []uint64) (result []financial_servicev1.AccountingAttachmentORM, err error)
}
...
//
// {{end}}
func (a accountingAttachmentORMDo) GetByID(id uint64) (result financial_servicev1.AccountingAttachmentORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (a accountingAttachmentORMDo) GetByIDs(ids []uint64) (result []financial_servicev1.AccountingAttachmentORM, err error) {
	var params []interface{}
