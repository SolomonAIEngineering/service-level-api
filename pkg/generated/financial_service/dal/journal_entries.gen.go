...
func newJournalEntryORM(db *gorm.DB, opts ...gen.DOOption) journalEntryORM {
	...
	_journalEntryORM.journalEntryORMDo.UseModel(&financial_servicev1.JournalEntryORM{})
	...
	_journalEntryORM.Lines = journalEntryORMHasManyLines{
		...
		RelationField: field.NewRelation("Lines", "financial_servicev1.JournalLineORM"),
	}
...
func (a journalEntryORMHasManyLines) Model(m *financial_servicev1.JournalEntryORM) *journalEntryORMHasManyLinesTx {
...
func (a journalEntryORMHasManyLinesTx) Find() (result []*financial_servicev1.JournalLineORM, err error) {
	return result, a.tx.Find(&result)
}

func (a journalEntryORMHasManyLinesTx) Append(values ...*financial_servicev1.JournalLineORM) (err error) {
...
func (a journalEntryORMHasManyLinesTx) Replace(values ...*financial_servicev1.JournalLineORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a journalEntryORMHasManyLinesTx) Delete(values ...*financial_servicev1.JournalLineORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type IJournalEntryORMDo interface {
	...
	Create(values ...*financial_servicev1.JournalEntryORM) error
	CreateInBatches(values []*financial_servicev1.JournalEntryORM, batchSize int) error
	Save(values ...*financial_servicev1.JournalEntryORM) error
	First() (*financial_servicev1.JournalEntryORM, error)
	Take() (*financial_servicev1.JournalEntryORM, error)
	Last() (*financial_servicev1.JournalEntryORM, error)
	Find() ([]*financial_servicev1.JournalEntryORM, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_servicev1.JournalEntryORM, err error)
	FindInBatches(result *[]*financial_servicev1.JournalEntryORM, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*financial_servicev1.JournalEntryORM) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*financial_servicev1.JournalEntryORM, error)
	FirstOrCreate() (*financial_servicev1.JournalEntryORM, error)
	FindByPage(offset int, limit int) (result []*financial_servicev1.JournalEntryORM, count int64, err error)
	...
	GetRecordByID(id int) (result financial_servicev1.JournalEntryORM, err error)
	GetRecordByIDs(ids []int) (result []financial_servicev1.JournalEntryORM, err error)
	CreateRecord(item financial_servicev1.JournalEntryORM) (err error)
	UpdateRecordByID(id int, item financial_servicev1.JournalEntryORM) (err error)
	DeleteRecordByID(id int) (err error)
	GetAllRecords(orderColumn string, limit int, offset int) (result []financial_servicev1.JournalEntryORM, err error)
	CountAll() (result int, err error)
	GetByID(id uint64) (result financial_servicev1.JournalEntryORM, err error)
	GetByIDs(ids []uint64) (result []financial_servicev1.JournalEntryORM, err error)
}
...
//
// {{end}}
func (j journalEntryORMDo) GetRecordByID(id int) (result financial_servicev1.JournalEntryORM, err error) {
...
//
// {{end}}
func (j journalEntryORMDo) GetRecordByIDs(ids []int) (result []financial_servicev1.JournalEntryORM, err error) {
	var params []interface{}
...
func (j journalEntryORMDo) CreateRecord(item financial_servicev1.JournalEntryORM) (err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (j journalEntryORMDo) UpdateRecordByID(id int, item financial_servicev1.JournalEntryORM) (err error) {
	var params []interface{}
...
func (j journalEntryORMDo) GetAllRecords(orderColumn string, limit int, offset int) (result []financial_servicev1.JournalEntryORM, err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (j journalEntryORMDo) GetByID(id uint64) (result financial_servicev1.JournalEntryORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (j journalEntryORMDo) GetByIDs(ids []uint64) (result []financial_servicev1.JournalEntryORM, err error) {
	var params []interface{}
...
func (j journalEntryORMDo) Create(values ...*financial_servicev1.JournalEntryORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (j journalEntryORMDo) CreateInBatches(values []*financial_servicev1.JournalEntryORM, batchSize int) error {
	return j.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (j journalEntryORMDo) Save(values ...*financial_servicev1.JournalEntryORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (j journalEntryORMDo) First() (*financial_servicev1.JournalEntryORM, error) {
	if result, err := j.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*financial_servicev1.JournalEntryORM), nil
	}
}

func (j journalEntryORMDo) Take() (*financial_servicev1.JournalEntryORM, error) {
...
func (j journalEntryORMDo) Last() (*financial_servicev1.JournalEntryORM, error) {
...
func (j journalEntryORMDo) Find() ([]*financial_servicev1.JournalEntryORM, error) {
	result, err := j.DO.Find()
	return result.([]*financial_servicev1.JournalEntryORM), err
}

func (j journalEntryORMDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_servicev1.JournalEntryORM, err error) {
	buf := make([]*financial_servicev1.JournalEntryORM, 0, batchSize)
...
func (j journalEntryORMDo) FindInBatches(result *[]*financial_servicev1.JournalEntryORM, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (j journalEntryORMDo) FirstOrInit() (*financial_servicev1.JournalEntryORM, error) {
...
func (j journalEntryORMDo) FirstOrCreate() (*financial_servicev1.JournalEntryORM, error) {
...
func (j journalEntryORMDo) FindByPage(offset int, limit int) (result []*financial_servicev1.JournalEntryORM, count int64, err error) {
...
func (j journalEntryORMDo) Delete(models ...*financial_servicev1.JournalEntryORM) (result gen.ResultInfo, err error) {
