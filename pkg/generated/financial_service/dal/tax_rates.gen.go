...
func newTaxRateORM(db *gorm.DB, opts ...gen.DOOption) taxRateORM {
	...
	_taxRateORM.taxRateORMDo.UseModel(&financial_servicev1.TaxRateORM{})
...
type ITaxRateORMDo interface {
	...
	Create(values ...*financial_servicev1.TaxRateORM) error
	CreateInBatches(values []*financial_servicev1.TaxRateORM, batchSize int) error
	Save(values ...*financial_servicev1.TaxRateORM) error
	First() (*financial_servicev1.TaxRateORM, error)
	Take() (*financial_servicev1.TaxRateORM, error)
	Last() (*financial_servicev1.TaxRateORM, error)
	Find() ([]*financial_servicev1.TaxRateORM, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_servicev1.TaxRateORM, err error)
	FindInBatches(result *[]*financial_servicev1.TaxRateORM, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*financial_servicev1.TaxRateORM) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*financial_servicev1.TaxRateORM, error)
	FirstOrCreate() (*financial_servicev1.TaxRateORM, error)
	FindByPage(offset int, limit int) (result []*financial_servicev1.TaxRateORM, count int64, err error)
	...
	GetRecordByID(id int) (result financial_servicev1.TaxRateORM, err error)
	GetRecordByIDs(ids []int) (result []financial_servicev1.TaxRateORM, err error)
	CreateRecord(item financial_servicev1.TaxRateORM) (err error)
	UpdateRecordByID(id int, item financial_servicev1.TaxRateORM) (err error)
	DeleteRecordByID(id int) (err error)
	GetAllRecords(orderColumn string, limit int, offset int) (result []financial_servicev1.TaxRateORM, err error)
	CountAll() (result int, err error)
	GetByID(id uint64) (result financial_servicev1.TaxRateORM, err error)
	GetByIDs(ids []uint64) (result []financial_servicev1.TaxRateORM, err error)
}
...
//
// {{end}}
func (t taxRateORMDo) GetRecordByID(id int) (result financial_servicev1.TaxRateORM, err error) {
...
//
// {{end}}
func (t taxRateORMDo) GetRecordByIDs(ids []int) (result []financial_servicev1.TaxRateORM, err error) {
	var params []interface{}
...
func (t taxRateORMDo) CreateRecord(item financial_servicev1.TaxRateORM) (err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (t taxRateORMDo) UpdateRecordByID(id int, item financial_servicev1.TaxRateORM) (err error) {
	var params []interface{}
...
func (t taxRateORMDo) GetAllRecords(orderColumn string, limit int, offset int) (result []financial_servicev1.TaxRateORM, err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (t taxRateORMDo) GetByID(id uint64) (result financial_servicev1.TaxRateORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (t taxRateORMDo) GetByIDs(ids []uint64) (result []financial_servicev1.TaxRateORM, err error) {
	var params []interface{}
...
func (t taxRateORMDo) Create(values ...*financial_servicev1.TaxRateORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (t taxRateORMDo) CreateInBatches(values []*financial_servicev1.TaxRateORM, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t taxRateORMDo) Save(values ...*financial_servicev1.TaxRateORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (t taxRateORMDo) First() (*financial_servicev1.TaxRateORM, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*financial_servicev1.TaxRateORM), nil
	}
}

func (t taxRateORMDo) Take() (*financial_servicev1.TaxRateORM, error) {
...
func (t taxRateORMDo) Last() (*financial_servicev1.TaxRateORM, error) {
...
func (t taxRateORMDo) Find() ([]*financial_servicev1.TaxRateORM, error) {
	result, err := t.DO.Find()
	return result.([]*financial_servicev1.TaxRateORM), err
}

func (t taxRateORMDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_servicev1.TaxRateORM, err error) {
	buf := make([]*financial_servicev1.TaxRateORM, 0, batchSize)
...
func (t taxRateORMDo) FindInBatches(result *[]*financial_servicev1.TaxRateORM, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t taxRateORMDo) FirstOrInit() (*financial_servicev1.TaxRateORM, error) {
...
func (t taxRateORMDo) FirstOrCreate() (*financial_servicev1.TaxRateORM, error) {
...
func (t taxRateORMDo) FindByPage(offset int, limit int) (result []*financial_servicev1.TaxRateORM, count int64, err error) {
...
func (t taxRateORMDo) Delete(models ...*financial_servicev1.TaxRateORM) (result gen.ResultInfo, err error) {
