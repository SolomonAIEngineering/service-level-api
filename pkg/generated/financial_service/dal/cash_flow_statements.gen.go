...
func newCashFlowStatementsORM(db *gorm.DB, opts ...gen.DOOption) cashFlowStatementsORM {
	...
	_cashFlowStatementsORM.cashFlowStatementsORMDo.UseModel(&financial_servicev1.CashFlowStatementsORM{})
	...
	_cashFlowStatementsORM.FinancingActivities = cashFlowStatementsORMHasManyFinancingActivities{
		...
		RelationField: field.NewRelation("FinancingActivities", "financial_servicev1.ReportItemORM"),
	}

	_cashFlowStatementsORM.InvestingActivities = cashFlowStatementsORMHasManyInvestingActivities{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("InvestingActivities", "financial_servicev1.ReportItemORM"),
	}

	_cashFlowStatementsORM.OperatingActivities = cashFlowStatementsORMHasManyOperatingActivities{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("OperatingActivities", "financial_servicev1.ReportItemORM"),
	}
...
func (a cashFlowStatementsORMHasManyFinancingActivities) Model(m *financial_servicev1.CashFlowStatementsORM) *cashFlowStatementsORMHasManyFinancingActivitiesTx {
...
func (a cashFlowStatementsORMHasManyFinancingActivitiesTx) Find() (result []*financial_servicev1.ReportItemORM, err error) {
	return result, a.tx.Find(&result)
}

func (a cashFlowStatementsORMHasManyFinancingActivitiesTx) Append(values ...*financial_servicev1.ReportItemORM) (err error) {
...
func (a cashFlowStatementsORMHasManyFinancingActivitiesTx) Replace(values ...*financial_servicev1.ReportItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a cashFlowStatementsORMHasManyFinancingActivitiesTx) Delete(values ...*financial_servicev1.ReportItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a cashFlowStatementsORMHasManyInvestingActivities) Model(m *financial_servicev1.CashFlowStatementsORM) *cashFlowStatementsORMHasManyInvestingActivitiesTx {
...
func (a cashFlowStatementsORMHasManyInvestingActivitiesTx) Find() (result []*financial_servicev1.ReportItemORM, err error) {
	return result, a.tx.Find(&result)
}

func (a cashFlowStatementsORMHasManyInvestingActivitiesTx) Append(values ...*financial_servicev1.ReportItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a cashFlowStatementsORMHasManyInvestingActivitiesTx) Replace(values ...*financial_servicev1.ReportItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a cashFlowStatementsORMHasManyInvestingActivitiesTx) Delete(values ...*financial_servicev1.ReportItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a cashFlowStatementsORMHasManyOperatingActivities) Model(m *financial_servicev1.CashFlowStatementsORM) *cashFlowStatementsORMHasManyOperatingActivitiesTx {
...
func (a cashFlowStatementsORMHasManyOperatingActivitiesTx) Find() (result []*financial_servicev1.ReportItemORM, err error) {
	return result, a.tx.Find(&result)
}

func (a cashFlowStatementsORMHasManyOperatingActivitiesTx) Append(values ...*financial_servicev1.ReportItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a cashFlowStatementsORMHasManyOperatingActivitiesTx) Replace(values ...*financial_servicev1.ReportItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a cashFlowStatementsORMHasManyOperatingActivitiesTx) Delete(values ...*financial_servicev1.ReportItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type ICashFlowStatementsORMDo interface {
	...
	Create(values ...*financial_servicev1.CashFlowStatementsORM) error
	CreateInBatches(values []*financial_servicev1.CashFlowStatementsORM, batchSize int) error
	Save(values ...*financial_servicev1.CashFlowStatementsORM) error
	First() (*financial_servicev1.CashFlowStatementsORM, error)
	Take() (*financial_servicev1.CashFlowStatementsORM, error)
	Last() (*financial_servicev1.CashFlowStatementsORM, error)
	Find() ([]*financial_servicev1.CashFlowStatementsORM, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_servicev1.CashFlowStatementsORM, err error)
	FindInBatches(result *[]*financial_servicev1.CashFlowStatementsORM, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*financial_servicev1.CashFlowStatementsORM) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*financial_servicev1.CashFlowStatementsORM, error)
	FirstOrCreate() (*financial_servicev1.CashFlowStatementsORM, error)
	FindByPage(offset int, limit int) (result []*financial_servicev1.CashFlowStatementsORM, count int64, err error)
	...
	GetRecordByID(id int) (result financial_servicev1.CashFlowStatementsORM, err error)
	GetRecordByIDs(ids []int) (result []financial_servicev1.CashFlowStatementsORM, err error)
	CreateRecord(item financial_servicev1.CashFlowStatementsORM) (err error)
	UpdateRecordByID(id int, item financial_servicev1.CashFlowStatementsORM) (err error)
...
//
// {{end}}
func (c cashFlowStatementsORMDo) GetRecordByID(id int) (result financial_servicev1.CashFlowStatementsORM, err error) {
...
//
// {{end}}
func (c cashFlowStatementsORMDo) GetRecordByIDs(ids []int) (result []financial_servicev1.CashFlowStatementsORM, err error) {
	var params []interface{}
...
func (c cashFlowStatementsORMDo) CreateRecord(item financial_servicev1.CashFlowStatementsORM) (err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (c cashFlowStatementsORMDo) UpdateRecordByID(id int, item financial_servicev1.CashFlowStatementsORM) (err error) {
	var params []interface{}
...
func (c cashFlowStatementsORMDo) GetAllRecords(orderColumn string, limit int, offset int) (result []financial_servicev1.CashFlowStatementsORM, err error) {
	var generateSQL strings.Builder
...
func (c cashFlowStatementsORMDo) Create(values ...*financial_servicev1.CashFlowStatementsORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (c cashFlowStatementsORMDo) CreateInBatches(values []*financial_servicev1.CashFlowStatementsORM, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c cashFlowStatementsORMDo) Save(values ...*financial_servicev1.CashFlowStatementsORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (c cashFlowStatementsORMDo) First() (*financial_servicev1.CashFlowStatementsORM, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*financial_servicev1.CashFlowStatementsORM), nil
	}
}

func (c cashFlowStatementsORMDo) Take() (*financial_servicev1.CashFlowStatementsORM, error) {
...
func (c cashFlowStatementsORMDo) Last() (*financial_servicev1.CashFlowStatementsORM, error) {
...
func (c cashFlowStatementsORMDo) Find() ([]*financial_servicev1.CashFlowStatementsORM, error) {
	result, err := c.DO.Find()
	return result.([]*financial_servicev1.CashFlowStatementsORM), err
}

func (c cashFlowStatementsORMDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_servicev1.CashFlowStatementsORM, err error) {
	buf := make([]*financial_servicev1.CashFlowStatementsORM, 0, batchSize)
...
func (c cashFlowStatementsORMDo) FindInBatches(result *[]*financial_servicev1.CashFlowStatementsORM, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c cashFlowStatementsORMDo) FirstOrInit() (*financial_servicev1.CashFlowStatementsORM, error) {
...
func (c cashFlowStatementsORMDo) FirstOrCreate() (*financial_servicev1.CashFlowStatementsORM, error) {
...
func (c cashFlowStatementsORMDo) FindByPage(offset int, limit int) (result []*financial_servicev1.CashFlowStatementsORM, count int64, err error) {
...
func (c cashFlowStatementsORMDo) Delete(models ...*financial_servicev1.CashFlowStatementsORM) (result gen.ResultInfo, err error) {
