...
type IPurchaseOrderLineItemORMDo interface {
	...
	GetByID(id uint64) (result financial_servicev1.PurchaseOrderLineItemORM, err error)
	GetByIDs(ids []uint64) (result []financial_servicev1.PurchaseOrderLineItemORM, err error)
}
...
//
// {{end}}
func (p purchaseOrderLineItemORMDo) GetByID(id uint64) (result financial_servicev1.PurchaseOrderLineItemORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (p purchaseOrderLineItemORMDo) GetByIDs(ids []uint64) (result []financial_servicev1.PurchaseOrderLineItemORM, err error) {
	var params []interface{}
