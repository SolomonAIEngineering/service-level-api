...
func newMergeLinkORM(db *gorm.DB, opts ...gen.DOOption) mergeLinkORM {
	...
	_mergeLinkORM.mergeLinkORMDo.UseModel(&financial_servicev1.MergeLinkORM{})
	...
	_mergeLinkORM.Account = mergeLinkORMHasManyAccount{
		...
		RelationField: field.NewRelation("Account", "financial_servicev1.LinkedAccountingAccountORM"),
		ReferenceDetails: struct {
			...
			RelationField: field.NewRelation("Account.ReferenceDetails", "financial_servicev1.ReferenceDetailsORM"),
			ChartOfAccounts: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Account.ReferenceDetails.ChartOfAccounts", "financial_servicev1.BusinessChartOfAccountsORM"),
			},
			Contacts: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Account.ReferenceDetails.Contacts", "financial_servicev1.ContactsORM"),
			},
			Items: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Account.ReferenceDetails.Items", "financial_servicev1.ItemORM"),
			},
			TaxRates: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Account.ReferenceDetails.TaxRates", "financial_servicev1.TaxRateORM"),
			},
		},
		ReportDetails: struct {
			...
			RelationField: field.NewRelation("Account.ReportDetails", "financial_servicev1.ReportDetailsORM"),
			BalanceSheets: struct {
				field.RelationField
				Assets struct {
					field.RelationField
				...
				RelationField: field.NewRelation("Account.ReportDetails.BalanceSheets", "financial_servicev1.BalanceSheetORM"),
				Assets: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("Account.ReportDetails.BalanceSheets.Assets", "financial_servicev1.ReportItemORM"),
				},
				Equity: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("Account.ReportDetails.BalanceSheets.Equity", "financial_servicev1.ReportItemORM"),
				},
				Liabilities: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("Account.ReportDetails.BalanceSheets.Liabilities", "financial_servicev1.ReportItemORM"),
				},
			},
			CashFlowStatements: struct {
				field.RelationField
				...
				RelationField: field.NewRelation("Account.ReportDetails.CashFlowStatements", "financial_servicev1.CashFlowStatementsORM"),
				FinancingActivities: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("Account.ReportDetails.CashFlowStatements.FinancingActivities", "financial_servicev1.ReportItemORM"),
				},
				InvestingActivities: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("Account.ReportDetails.CashFlowStatements.InvestingActivities", "financial_servicev1.ReportItemORM"),
				},
				OperatingActivities: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("Account.ReportDetails.CashFlowStatements.OperatingActivities", "financial_servicev1.ReportItemORM"),
				},
			},
			IncomeStatements: struct {
				field.RelationField
				...
				RelationField: field.NewRelation("Account.ReportDetails.IncomeStatements", "financial_servicev1.IncomeStatementORM"),
				CostOfSales: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("Account.ReportDetails.IncomeStatements.CostOfSales", "financial_servicev1.ReportItemORM"),
				},
				Income: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("Account.ReportDetails.IncomeStatements.Income", "financial_servicev1.ReportItemORM"),
				},
				NonOperatingExpenses: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("Account.ReportDetails.IncomeStatements.NonOperatingExpenses", "financial_servicev1.ReportItemORM"),
				},
				OperatingExpenses: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("Account.ReportDetails.IncomeStatements.OperatingExpenses", "financial_servicev1.ReportItemORM"),
				},
			},
		},
		TransactionsDetails: struct {
			...
			RelationField: field.NewRelation("Account.TransactionsDetails", "financial_servicev1.TransactionDetailsORM"),
			CreditNotes: struct {
				field.RelationField
				LineItems struct {
					field.RelationField
				...
				RelationField: field.NewRelation("Account.TransactionsDetails.CreditNotes", "financial_servicev1.CreditNoteORM"),
				LineItems: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("Account.TransactionsDetails.CreditNotes.LineItems", "financial_servicev1.CreditNoteLineItemORM"),
				},
			},
			Expenses: struct {
				field.RelationField
				...
				RelationField: field.NewRelation("Account.TransactionsDetails.Expenses", "financial_servicev1.ExpenseORM"),
				Lines: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("Account.TransactionsDetails.Expenses.Lines", "financial_servicev1.ExpenseLineORM"),
				},
			},
			Invoices: struct {
				field.RelationField
				...
				RelationField: field.NewRelation("Account.TransactionsDetails.Invoices", "financial_servicev1.InvoiceORM"),
				LineItems: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("Account.TransactionsDetails.Invoices.LineItems", "financial_servicev1.InvoiceLineItemORM"),
				},
			},
			JournalEntries: struct {
				field.RelationField
				...
				RelationField: field.NewRelation("Account.TransactionsDetails.JournalEntries", "financial_servicev1.JournalEntryORM"),
				Lines: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("Account.TransactionsDetails.JournalEntries.Lines", "financial_servicev1.JournalLineORM"),
				},
			},
			Payments: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Account.TransactionsDetails.Payments", "financial_servicev1.PaymentORM"),
			},
			Transactions: struct {
				field.RelationField
				LineItems struct {
				...
				RelationField: field.NewRelation("Account.TransactionsDetails.Transactions", "financial_servicev1.BusinessTransactionORM"),
				LineItems: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("Account.TransactionsDetails.Transactions.LineItems", "financial_servicev1.TransactionLineItemORM"),
				},
			},
			VendorCredits: struct {
				field.RelationField
				...
				RelationField: field.NewRelation("Account.TransactionsDetails.VendorCredits", "financial_servicev1.VendorCreditORM"),
				Lines: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("Account.TransactionsDetails.VendorCredits.Lines", "financial_servicev1.VendorCreditLineORM"),
				},
			},
		},
		Attachments: struct {
			...
			RelationField: field.NewRelation("Account.Attachments", "financial_servicev1.AttachmentsORM"),
		},
		CompanyInfo: struct {
			field.RelationField
			Addresses struct {
			...
			RelationField: field.NewRelation("Account.CompanyInfo", "financial_servicev1.CompanyInfoORM"),
			Addresses: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Account.CompanyInfo.Addresses", "financial_servicev1.AddressORM"),
			},
		},
		PurchaseOrders: struct {
			...
			RelationField: field.NewRelation("Account.PurchaseOrders", "financial_servicev1.PurchaseOrderORM"),
			DeliveryAddress: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Account.PurchaseOrders.DeliveryAddress", "financial_servicev1.AddressORM"),
			},
			LineItems: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Account.PurchaseOrders.LineItems", "financial_servicev1.PurchaseOrderLineItemORM"),
			},
		},
	}
...
func (a mergeLinkORMHasOneToken) Model(m *financial_servicev1.MergeLinkORM) *mergeLinkORMHasOneTokenTx {
...
func (a mergeLinkORMHasOneTokenTx) Find() (result *financial_servicev1.TokenORM, err error) {
	return result, a.tx.Find(&result)
}

func (a mergeLinkORMHasOneTokenTx) Append(values ...*financial_servicev1.TokenORM) (err error) {
...
func (a mergeLinkORMHasOneTokenTx) Replace(values ...*financial_servicev1.TokenORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a mergeLinkORMHasOneTokenTx) Delete(values ...*financial_servicev1.TokenORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a mergeLinkORMHasManyAccount) Model(m *financial_servicev1.MergeLinkORM) *mergeLinkORMHasManyAccountTx {
...
func (a mergeLinkORMHasManyAccountTx) Find() (result []*financial_servicev1.LinkedAccountingAccountORM, err error) {
	return result, a.tx.Find(&result)
}

func (a mergeLinkORMHasManyAccountTx) Append(values ...*financial_servicev1.LinkedAccountingAccountORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a mergeLinkORMHasManyAccountTx) Replace(values ...*financial_servicev1.LinkedAccountingAccountORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a mergeLinkORMHasManyAccountTx) Delete(values ...*financial_servicev1.LinkedAccountingAccountORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type IMergeLinkORMDo interface {
	...
	Create(values ...*financial_servicev1.MergeLinkORM) error
	CreateInBatches(values []*financial_servicev1.MergeLinkORM, batchSize int) error
	Save(values ...*financial_servicev1.MergeLinkORM) error
	First() (*financial_servicev1.MergeLinkORM, error)
	Take() (*financial_servicev1.MergeLinkORM, error)
	Last() (*financial_servicev1.MergeLinkORM, error)
	Find() ([]*financial_servicev1.MergeLinkORM, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_servicev1.MergeLinkORM, err error)
	FindInBatches(result *[]*financial_servicev1.MergeLinkORM, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*financial_servicev1.MergeLinkORM) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*financial_servicev1.MergeLinkORM, error)
	FirstOrCreate() (*financial_servicev1.MergeLinkORM, error)
	FindByPage(offset int, limit int) (result []*financial_servicev1.MergeLinkORM, count int64, err error)
	...
	GetRecordByID(id int) (result financial_servicev1.MergeLinkORM, err error)
	GetRecordByIDs(ids []int) (result []financial_servicev1.MergeLinkORM, err error)
	CreateRecord(item financial_servicev1.MergeLinkORM) (err error)
	UpdateRecordByID(id int, item financial_servicev1.MergeLinkORM) (err error)
	DeleteRecordByID(id int) (err error)
	GetAllRecords(orderColumn string, limit int, offset int) (result []financial_servicev1.MergeLinkORM, err error)
	CountAll() (result int, err error)
	GetByID(id uint64) (result financial_servicev1.MergeLinkORM, err error)
	GetByIDs(ids []uint64) (result []financial_servicev1.MergeLinkORM, err error)
}
...
//
// {{end}}
func (m mergeLinkORMDo) GetRecordByID(id int) (result financial_servicev1.MergeLinkORM, err error) {
...
//
// {{end}}
func (m mergeLinkORMDo) GetRecordByIDs(ids []int) (result []financial_servicev1.MergeLinkORM, err error) {
	var params []interface{}
...
func (m mergeLinkORMDo) CreateRecord(item financial_servicev1.MergeLinkORM) (err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (m mergeLinkORMDo) UpdateRecordByID(id int, item financial_servicev1.MergeLinkORM) (err error) {
	var params []interface{}
...
func (m mergeLinkORMDo) GetAllRecords(orderColumn string, limit int, offset int) (result []financial_servicev1.MergeLinkORM, err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (m mergeLinkORMDo) GetByID(id uint64) (result financial_servicev1.MergeLinkORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (m mergeLinkORMDo) GetByIDs(ids []uint64) (result []financial_servicev1.MergeLinkORM, err error) {
	var params []interface{}
...
func (m mergeLinkORMDo) Create(values ...*financial_servicev1.MergeLinkORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (m mergeLinkORMDo) CreateInBatches(values []*financial_servicev1.MergeLinkORM, batchSize int) error {
	return m.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (m mergeLinkORMDo) Save(values ...*financial_servicev1.MergeLinkORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (m mergeLinkORMDo) First() (*financial_servicev1.MergeLinkORM, error) {
	if result, err := m.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*financial_servicev1.MergeLinkORM), nil
	}
}

func (m mergeLinkORMDo) Take() (*financial_servicev1.MergeLinkORM, error) {
...
func (m mergeLinkORMDo) Last() (*financial_servicev1.MergeLinkORM, error) {
...
func (m mergeLinkORMDo) Find() ([]*financial_servicev1.MergeLinkORM, error) {
	result, err := m.DO.Find()
	return result.([]*financial_servicev1.MergeLinkORM), err
}

func (m mergeLinkORMDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_servicev1.MergeLinkORM, err error) {
	buf := make([]*financial_servicev1.MergeLinkORM, 0, batchSize)
...
func (m mergeLinkORMDo) FindInBatches(result *[]*financial_servicev1.MergeLinkORM, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (m mergeLinkORMDo) FirstOrInit() (*financial_servicev1.MergeLinkORM, error) {
...
func (m mergeLinkORMDo) FirstOrCreate() (*financial_servicev1.MergeLinkORM, error) {
...
func (m mergeLinkORMDo) FindByPage(offset int, limit int) (result []*financial_servicev1.MergeLinkORM, count int64, err error) {
...
func (m mergeLinkORMDo) Delete(models ...*financial_servicev1.MergeLinkORM) (result gen.ResultInfo, err error) {
