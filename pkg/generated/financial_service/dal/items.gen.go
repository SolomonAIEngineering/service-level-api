...
func newItemORM(db *gorm.DB, opts ...gen.DOOption) itemORM {
	...
	_itemORM.itemORMDo.UseModel(&financial_servicev1.ItemORM{})
...
type IItemORMDo interface {
	...
	Unscoped() IItemORMDo
	Create(values ...*financial_servicev1.ItemORM) error
	CreateInBatches(values []*financial_servicev1.ItemORM, batchSize int) error
	Save(values ...*financial_servicev1.ItemORM) error
	First() (*financial_servicev1.ItemORM, error)
	Take() (*financial_servicev1.ItemORM, error)
	Last() (*financial_servicev1.ItemORM, error)
	Find() ([]*financial_servicev1.ItemORM, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_servicev1.ItemORM, err error)
	FindInBatches(result *[]*financial_servicev1.ItemORM, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*financial_servicev1.ItemORM) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*financial_servicev1.ItemORM, error)
	FirstOrCreate() (*financial_servicev1.ItemORM, error)
	FindByPage(offset int, limit int) (result []*financial_servicev1.ItemORM, count int64, err error)
	...
	GetRecordByID(id int) (result financial_servicev1.ItemORM, err error)
	GetRecordByIDs(ids []int) (result []financial_servicev1.ItemORM, err error)
	CreateRecord(item financial_servicev1.ItemORM) (err error)
	UpdateRecordByID(id int, item financial_servicev1.ItemORM) (err error)
	DeleteRecordByID(id int) (err error)
	GetAllRecords(orderColumn string, limit int, offset int) (result []financial_servicev1.ItemORM, err error)
	CountAll() (result int, err error)
	GetByID(id uint64) (result financial_servicev1.ItemORM, err error)
	GetByIDs(ids []uint64) (result []financial_servicev1.ItemORM, err error)
}
...
//
// {{end}}
func (i itemORMDo) GetRecordByID(id int) (result financial_servicev1.ItemORM, err error) {
...
//
// {{end}}
func (i itemORMDo) GetRecordByIDs(ids []int) (result []financial_servicev1.ItemORM, err error) {
	var params []interface{}
...
func (i itemORMDo) CreateRecord(item financial_servicev1.ItemORM) (err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (i itemORMDo) UpdateRecordByID(id int, item financial_servicev1.ItemORM) (err error) {
	var params []interface{}
...
func (i itemORMDo) GetAllRecords(orderColumn string, limit int, offset int) (result []financial_servicev1.ItemORM, err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (i itemORMDo) GetByID(id uint64) (result financial_servicev1.ItemORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (i itemORMDo) GetByIDs(ids []uint64) (result []financial_servicev1.ItemORM, err error) {
	var params []interface{}
...
func (i itemORMDo) Create(values ...*financial_servicev1.ItemORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (i itemORMDo) CreateInBatches(values []*financial_servicev1.ItemORM, batchSize int) error {
	return i.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (i itemORMDo) Save(values ...*financial_servicev1.ItemORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (i itemORMDo) First() (*financial_servicev1.ItemORM, error) {
	if result, err := i.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*financial_servicev1.ItemORM), nil
	}
}

func (i itemORMDo) Take() (*financial_servicev1.ItemORM, error) {
...
func (i itemORMDo) Last() (*financial_servicev1.ItemORM, error) {
...
func (i itemORMDo) Find() ([]*financial_servicev1.ItemORM, error) {
	result, err := i.DO.Find()
	return result.([]*financial_servicev1.ItemORM), err
}

func (i itemORMDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_servicev1.ItemORM, err error) {
	buf := make([]*financial_servicev1.ItemORM, 0, batchSize)
...
func (i itemORMDo) FindInBatches(result *[]*financial_servicev1.ItemORM, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (i itemORMDo) FirstOrInit() (*financial_servicev1.ItemORM, error) {
...
func (i itemORMDo) FirstOrCreate() (*financial_servicev1.ItemORM, error) {
...
func (i itemORMDo) FindByPage(offset int, limit int) (result []*financial_servicev1.ItemORM, count int64, err error) {
...
func (i itemORMDo) Delete(models ...*financial_servicev1.ItemORM) (result gen.ResultInfo, err error) {
