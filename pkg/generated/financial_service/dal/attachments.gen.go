...
func newAttachmentsORM(db *gorm.DB, opts ...gen.DOOption) attachmentsORM {
	...
	_attachmentsORM.attachmentsORMDo.UseModel(&financial_servicev1.AttachmentsORM{})
...
type IAttachmentsORMDo interface {
	...
	Create(values ...*financial_servicev1.AttachmentsORM) error
	CreateInBatches(values []*financial_servicev1.AttachmentsORM, batchSize int) error
	Save(values ...*financial_servicev1.AttachmentsORM) error
	First() (*financial_servicev1.AttachmentsORM, error)
	Take() (*financial_servicev1.AttachmentsORM, error)
	Last() (*financial_servicev1.AttachmentsORM, error)
	Find() ([]*financial_servicev1.AttachmentsORM, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_servicev1.AttachmentsORM, err error)
	FindInBatches(result *[]*financial_servicev1.AttachmentsORM, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*financial_servicev1.AttachmentsORM) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*financial_servicev1.AttachmentsORM, error)
	FirstOrCreate() (*financial_servicev1.AttachmentsORM, error)
	FindByPage(offset int, limit int) (result []*financial_servicev1.AttachmentsORM, count int64, err error)
	...
	GetRecordByID(id int) (result financial_servicev1.AttachmentsORM, err error)
	GetRecordByIDs(ids []int) (result []financial_servicev1.AttachmentsORM, err error)
	CreateRecord(item financial_servicev1.AttachmentsORM) (err error)
	UpdateRecordByID(id int, item financial_servicev1.AttachmentsORM) (err error)
	DeleteRecordByID(id int) (err error)
	GetAllRecords(orderColumn string, limit int, offset int) (result []financial_servicev1.AttachmentsORM, err error)
	CountAll() (result int, err error)
	GetByID(id uint64) (result financial_servicev1.AttachmentsORM, err error)
	GetByIDs(ids []uint64) (result []financial_servicev1.AttachmentsORM, err error)
}
...
//
// {{end}}
func (a attachmentsORMDo) GetRecordByID(id int) (result financial_servicev1.AttachmentsORM, err error) {
...
//
// {{end}}
func (a attachmentsORMDo) GetRecordByIDs(ids []int) (result []financial_servicev1.AttachmentsORM, err error) {
	var params []interface{}
...
func (a attachmentsORMDo) CreateRecord(item financial_servicev1.AttachmentsORM) (err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (a attachmentsORMDo) UpdateRecordByID(id int, item financial_servicev1.AttachmentsORM) (err error) {
	var params []interface{}
...
func (a attachmentsORMDo) GetAllRecords(orderColumn string, limit int, offset int) (result []financial_servicev1.AttachmentsORM, err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (a attachmentsORMDo) GetByID(id uint64) (result financial_servicev1.AttachmentsORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (a attachmentsORMDo) GetByIDs(ids []uint64) (result []financial_servicev1.AttachmentsORM, err error) {
	var params []interface{}
...
func (a attachmentsORMDo) Create(values ...*financial_servicev1.AttachmentsORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (a attachmentsORMDo) CreateInBatches(values []*financial_servicev1.AttachmentsORM, batchSize int) error {
	return a.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (a attachmentsORMDo) Save(values ...*financial_servicev1.AttachmentsORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (a attachmentsORMDo) First() (*financial_servicev1.AttachmentsORM, error) {
	if result, err := a.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*financial_servicev1.AttachmentsORM), nil
	}
}

func (a attachmentsORMDo) Take() (*financial_servicev1.AttachmentsORM, error) {
...
func (a attachmentsORMDo) Last() (*financial_servicev1.AttachmentsORM, error) {
...
func (a attachmentsORMDo) Find() ([]*financial_servicev1.AttachmentsORM, error) {
	result, err := a.DO.Find()
	return result.([]*financial_servicev1.AttachmentsORM), err
}

func (a attachmentsORMDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_servicev1.AttachmentsORM, err error) {
	buf := make([]*financial_servicev1.AttachmentsORM, 0, batchSize)
...
func (a attachmentsORMDo) FindInBatches(result *[]*financial_servicev1.AttachmentsORM, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (a attachmentsORMDo) FirstOrInit() (*financial_servicev1.AttachmentsORM, error) {
...
func (a attachmentsORMDo) FirstOrCreate() (*financial_servicev1.AttachmentsORM, error) {
...
func (a attachmentsORMDo) FindByPage(offset int, limit int) (result []*financial_servicev1.AttachmentsORM, count int64, err error) {
...
func (a attachmentsORMDo) Delete(models ...*financial_servicev1.AttachmentsORM) (result gen.ResultInfo, err error) {
