...
func newCreditNoteORM(db *gorm.DB, opts ...gen.DOOption) creditNoteORM {
	...
	_creditNoteORM.creditNoteORMDo.UseModel(&financial_servicev1.CreditNoteORM{})
	...
	_creditNoteORM.LineItems = creditNoteORMHasManyLineItems{
		...
		RelationField: field.NewRelation("LineItems", "financial_servicev1.CreditNoteLineItemORM"),
	}
...
func (a creditNoteORMHasManyLineItems) Model(m *financial_servicev1.CreditNoteORM) *creditNoteORMHasManyLineItemsTx {
...
func (a creditNoteORMHasManyLineItemsTx) Find() (result []*financial_servicev1.CreditNoteLineItemORM, err error) {
	return result, a.tx.Find(&result)
}

func (a creditNoteORMHasManyLineItemsTx) Append(values ...*financial_servicev1.CreditNoteLineItemORM) (err error) {
...
func (a creditNoteORMHasManyLineItemsTx) Replace(values ...*financial_servicev1.CreditNoteLineItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a creditNoteORMHasManyLineItemsTx) Delete(values ...*financial_servicev1.CreditNoteLineItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type ICreditNoteORMDo interface {
	...
	Create(values ...*financial_servicev1.CreditNoteORM) error
	CreateInBatches(values []*financial_servicev1.CreditNoteORM, batchSize int) error
	Save(values ...*financial_servicev1.CreditNoteORM) error
	First() (*financial_servicev1.CreditNoteORM, error)
	Take() (*financial_servicev1.CreditNoteORM, error)
	Last() (*financial_servicev1.CreditNoteORM, error)
	Find() ([]*financial_servicev1.CreditNoteORM, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_servicev1.CreditNoteORM, err error)
	FindInBatches(result *[]*financial_servicev1.CreditNoteORM, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*financial_servicev1.CreditNoteORM) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*financial_servicev1.CreditNoteORM, error)
	FirstOrCreate() (*financial_servicev1.CreditNoteORM, error)
	FindByPage(offset int, limit int) (result []*financial_servicev1.CreditNoteORM, count int64, err error)
	...
	GetRecordByID(id int) (result financial_servicev1.CreditNoteORM, err error)
	GetRecordByIDs(ids []int) (result []financial_servicev1.CreditNoteORM, err error)
	CreateRecord(item financial_servicev1.CreditNoteORM) (err error)
	UpdateRecordByID(id int, item financial_servicev1.CreditNoteORM) (err error)
	DeleteRecordByID(id int) (err error)
	GetAllRecords(orderColumn string, limit int, offset int) (result []financial_servicev1.CreditNoteORM, err error)
	CountAll() (result int, err error)
	GetByID(id uint64) (result financial_servicev1.CreditNoteORM, err error)
	GetByIDs(ids []uint64) (result []financial_servicev1.CreditNoteORM, err error)
}
...
//
// {{end}}
func (c creditNoteORMDo) GetRecordByID(id int) (result financial_servicev1.CreditNoteORM, err error) {
...
//
// {{end}}
func (c creditNoteORMDo) GetRecordByIDs(ids []int) (result []financial_servicev1.CreditNoteORM, err error) {
	var params []interface{}
...
func (c creditNoteORMDo) CreateRecord(item financial_servicev1.CreditNoteORM) (err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (c creditNoteORMDo) UpdateRecordByID(id int, item financial_servicev1.CreditNoteORM) (err error) {
	var params []interface{}
...
func (c creditNoteORMDo) GetAllRecords(orderColumn string, limit int, offset int) (result []financial_servicev1.CreditNoteORM, err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (c creditNoteORMDo) GetByID(id uint64) (result financial_servicev1.CreditNoteORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (c creditNoteORMDo) GetByIDs(ids []uint64) (result []financial_servicev1.CreditNoteORM, err error) {
	var params []interface{}
...
func (c creditNoteORMDo) Create(values ...*financial_servicev1.CreditNoteORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (c creditNoteORMDo) CreateInBatches(values []*financial_servicev1.CreditNoteORM, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c creditNoteORMDo) Save(values ...*financial_servicev1.CreditNoteORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (c creditNoteORMDo) First() (*financial_servicev1.CreditNoteORM, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*financial_servicev1.CreditNoteORM), nil
	}
}

func (c creditNoteORMDo) Take() (*financial_servicev1.CreditNoteORM, error) {
...
func (c creditNoteORMDo) Last() (*financial_servicev1.CreditNoteORM, error) {
...
func (c creditNoteORMDo) Find() ([]*financial_servicev1.CreditNoteORM, error) {
	result, err := c.DO.Find()
	return result.([]*financial_servicev1.CreditNoteORM), err
}

func (c creditNoteORMDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_servicev1.CreditNoteORM, err error) {
	buf := make([]*financial_servicev1.CreditNoteORM, 0, batchSize)
...
func (c creditNoteORMDo) FindInBatches(result *[]*financial_servicev1.CreditNoteORM, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c creditNoteORMDo) FirstOrInit() (*financial_servicev1.CreditNoteORM, error) {
...
func (c creditNoteORMDo) FirstOrCreate() (*financial_servicev1.CreditNoteORM, error) {
...
func (c creditNoteORMDo) FindByPage(offset int, limit int) (result []*financial_servicev1.CreditNoteORM, count int64, err error) {
...
func (c creditNoteORMDo) Delete(models ...*financial_servicev1.CreditNoteORM) (result gen.ResultInfo, err error) {
