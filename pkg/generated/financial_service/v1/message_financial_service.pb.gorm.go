...
type UserProfileORM struct {
	...
	ActionablePersonalInsights []*PersonalActionableInsightORM `gorm:"foreignkey:UserProfileId;association_foreignkey:Id;preload:true"`
	Email                      string
	Id                         uint64
	Link                       []*LinkORM      `gorm:"foreignkey:UserProfileId;association_foreignkey:Id;preload:true"`
	MergeLiink                 []*MergeLinkORM `gorm:"foreignkey:UserProfileId;association_foreignkey:Id"`
...
func DefaultStrictUpdateUserProfile(ctx context.Context, in *UserProfile, db *gorm.DB) (*UserProfile, error) {
	...
	filterActionableInsights.UserProfileId = new(uint64)
	*filterActionableInsights.UserProfileId = ormObj.Id
	...
	filterActionablePersonalInsights.UserProfileId = new(uint64)
	*filterActionablePersonalInsights.UserProfileId = ormObj.Id
	...
	filterLink.UserProfileId = new(uint64)
	*filterLink.UserProfileId = ormObj.Id
	...
	filterMergeLiink.UserProfileId = new(uint64)
	*filterMergeLiink.UserProfileId = ormObj.Id
	...
	filterStripeSubscriptions.UserProfileId = new(uint64)
	*filterStripeSubscriptions.UserProfileId = ormObj.Id
