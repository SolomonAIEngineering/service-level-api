...
type FinancialUserProfileORM struct {
	...
	UserId                     uint64                          `gorm:"index:idx_financial_user_profile_user_id"`
}
...
type CreditAccountORM struct {
	...
	Type                   string
	UserId                 uint64 `gorm:"index:idx_credit_account_user_id"`
}
...
type InvestmentAccountORM struct {
	...
	Type           string
	UserId         uint64 `gorm:"index:idx_investment_account_user_id"`
}
...
type BankAccountORM struct {
	...
	Type                  string
	UserId                uint64 `gorm:"index:idx_bank_account_user_id"`
}
...
type SmartGoalORM struct {
	...
	StartDate     string
	TargetAmount  string
	UserId        uint64 `gorm:"index:idx_smart_goal_user_id"`
}
...
type SmartNoteORM struct {
	...
	SmartGoalId                         *uint64
	UpdatedAt                           *time.Time
	UserId                              uint64 `gorm:"index:idx_smart_note_user_id"`
}
...
type PlaidAccountInvestmentTransactionORM struct {
	...
	Type                    string
	UnofficialCurrencyCode  string
	UserId                  uint64 `gorm:"index:idx_investment_transaction_user_id"`
}
...
type PlaidAccountRecurringTransactionORM struct {
	...
	UserId                          uint64 `gorm:"index:idx_recurring_transaction_user_id"`
}
...
type PlaidAccountTransactionORM struct {
	...
	UnofficialCurrencyCode          string
	UserId                          uint64 `gorm:"index:idx_transaction_user_id"`
}
