...
// Validate checks the field values on TransactionNote with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *TransactionNote) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on TransactionNote with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// TransactionNoteMultiError, or nil if none found.
func (m *TransactionNote) ValidateAll() error {
	return m.validate(true)
}

func (m *TransactionNote) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, TransactionNoteValidationError{
					field:  "CreatedAt",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return TransactionNoteValidationError{
				field:  "CreatedAt",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return TransactionNoteMultiError(errors)
	}

	return nil
}

// TransactionNoteMultiError is an error wrapping multiple validation errors
// returned by TransactionNote.ValidateAll() if the designated constraints
// aren't met.
type TransactionNoteMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m TransactionNoteMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m TransactionNoteMultiError) AllErrors() []error { return m }

// TransactionNoteValidationError is the validation error returned by
// TransactionNote.Validate if the designated constraints aren't met.
type TransactionNoteValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e TransactionNoteValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e TransactionNoteValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e TransactionNoteValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e TransactionNoteValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e TransactionNoteValidationError) ErrorName() string { return "TransactionNoteValidationError" }

// Error satisfies the builtin error interface
func (e TransactionNoteValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sTransactionNote.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = TransactionNoteValidationError{}
