...
| requestor_profile_type | [VirtualProfileType](#social_service-v2-VirtualProfileType) |  | the profile type of the user that is perfoming this operation | type: string |
...
| editor_profile_type | [VirtualProfileType](#social_service-v2-VirtualProfileType) |  | the editor profile type of the user that is perfoming this operation | type: string |
...
| editor_user_id | [uint64](#uint64) |  |  |
| publication_id | [uint64](#uint64) |  |  |
| admin_profile_type | [VirtualProfileType](#social_service-v2-VirtualProfileType) |  | the admin profile type of the user that is perfoming this operation | type: string |
| editor_profile_type | [VirtualProfileType](#social_service-v2-VirtualProfileType) |  | the editor profile type of the user that is perfoming this operation | type: string |
...
| source_profile_type | [VirtualProfileType](#social_service-v2-VirtualProfileType) |  | the profile type of the user that is trying to block another user |
| target_profile_type | [VirtualProfileType](#social_service-v2-VirtualProfileType) |  | the profile type of the user that is being blocked |
...
| profile_type | [VirtualProfileType](#social_service-v2-VirtualProfileType) |  | the virtual profile type of the user creating the community profile |
...
| requestor_profile_type | [VirtualProfileType](#social_service-v2-VirtualProfileType) |  | the profile type of the user that is trying to delete this community |
...
| ----- | ---- | ----- | ----------- |
| user_id | [uint64](#uint64) |  | the user ID trying to delete this user profile (NOTE: userID refers to the ID from the vantage point of the user service. This ID is the single source of truth for a given user across our suite of services) | type: uint64 |
| profile_type | [VirtualProfileType](#social_service-v2-VirtualProfileType) |  | the virtual profile type of the user that is being deleted |
...
| user_id | [uint64](#uint64) |  | the user ID trying to update this community profile (NOTE: userID refers to the ID from the vantage point of the user service. This ID is the single source of truth for a given user across our suite of services) | type: uint64 |
| community_profile_id | [uint64](#uint64) |  | The community profile ID of the community being updated | type: uint64 |
| requestor_profile_type | [VirtualProfileType](#social_service-v2-VirtualProfileType) |  | the virtual profile of the user that is trying to perform the update |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| user_id | [uint64](#uint64) |  | the user ID trying to update this user profile (NOTE: userID refers to the ID from the vantage point of the user service. This ID is the single source of truth for a given user across our suite of services) | type: uint64 |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| source_user_id | [uint64](#uint64) |  | the user ID trying to follow another user (NOTE: userID refers to the ID from the vantage point of the user service. This ID is the single source of truth for a given user across our suite of services) | type: uint64 |
| target_community_profile_id | [uint64](#uint64) |  | the targetCommunityProfileID ID being followed by another user |
| source_profile_type | [VirtualProfileType](#social_service-v2-VirtualProfileType) |  | the profile type of the user that is trying to follow another community |
...
| ----- | ---- | ----- | ----------- |
| source_user_id | [uint64](#uint64) |  | the user ID trying to follow another user (NOTE: userID refers to the ID from the vantage point of the user service. This ID is the single source of truth for a given user across our suite of services) | type: uint64 |
| target_user_id | [uint64](#uint64) |  | the user ID being followed by another user (NOTE: userID refers to the ID from the vantage point of the user service. This ID is the single source of truth for a given user across our suite of services) | type: uint64 |
| source_profile_type | [VirtualProfileType](#social_service-v2-VirtualProfileType) |  | the profile type of the user that is trying to follow another user |
| target_profile_type | [VirtualProfileType](#social_service-v2-VirtualProfileType) |  | the profile type of the user that is being followed |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| user_id | [uint64](#uint64) |  | the user ID who&#39;s communities follow set we want to obtain (NOTE: userID refers to the ID from the vantage point of the user service. This ID is the single source of truth for a given user across our suite of services) | type: uint64 |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| user_id | [uint64](#uint64) |  | the user ID who&#39;s pending request we want to obtain (NOTE: userID refers to the ID from the vantage point of the user service. This ID is the single source of truth for a given user across our suite of services) | type: uint64 |
| requestor_profile_type | [VirtualProfileType](#social_service-v2-VirtualProfileType) |  | the profile type of the user that is perfoming this operation | type: string |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| user_id | [uint64](#uint64) |  | the user ID trying to obtain a post (NOTE: userID refers to the ID from the vantage point of the user service. This ID is the single source of truth for a given user across our suite of services) | type: uint64 |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| user_id | [uint64](#uint64) |  | the user ID whose communities topics follow set we want to obtain (NOTE: userID refers to the ID from the vantage point of the user service. This ID is the single source of truth for a given user across our suite of services) | type: uint64 |
| limit | [uint64](#uint64) |  |  |
| requestor_profile_type | [VirtualProfileType](#social_service-v2-VirtualProfileType) |  | the profile type of the user that is perfoming this operation | type: string |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| user_id | [uint64](#uint64) |  | the user ID trying to obtain a given feed (NOTE: userID refers to the ID from the vantage point of the user service. This ID is the single source of truth for a given user across our suite of services) | type: uint64 |
| feed_type | [FeedType](#social_service-v2-FeedType) |  | The type of feed aiming to be obtained | type: string |
| account_type | [AccountType](#social_service-v2-AccountType) |  | The type of account making the request to obtain the feed | type: string |
| next_page_token | [string](#string) |  |  |
| requestor_profile_type | [VirtualProfileType](#social_service-v2-VirtualProfileType) |  | the profile type of the user that is perfoming this operation | type: string |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| user_id | [uint64](#uint64) |  | The user ID associated with the profile we want to get | type: uint64 |
| requestor_profile_id | [uint64](#uint64) |  | The RequestorProfileID is an optional parameter used to check if the profileID (requestor) making a request for the record actually follows the record |
| requestor_profile_type | [AccountType](#social_service-v2-AccountType) |  | The RequestorProfileType is an optional parameter which tells us what type of profile is the requestor |
| requestor_virtual_profile_type | [VirtualProfileType](#social_service-v2-VirtualProfileType) |  |  |
| requested_virtual_profile_type | [VirtualProfileType](#social_service-v2-VirtualProfileType) |  |  |
...
| user_id | [uint64](#uint64) |  | the user ID trying to add a reaction (NOTE: user_id refers to the ID from the vantage point of the user service. This ID is the single source of truth for a given user across our suite of services) | type: uint64 |
