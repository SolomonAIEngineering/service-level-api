...
@param GetUserByEmailOrUsernameV2Request Contains the email or username to query the account. @return GetUserByEmailOrUsernameV2Response Provides the status of the operation. |
...
This RPC is used to fetch settings for a specific business account. It queries based on the user ID and returns the associated settings.
...
| UpdateBusinessSettings | [UpdateBusinessSettingsRequest](#user_service-v1-UpdateBusinessSettingsRequest) | [UpdateBusinessSettingsResponse](#user_service-v1-UpdateBusinessSettingsResponse) | @brief Updates business account settings.

This RPC allows users to update settings for a business account. It takes in new settings as parameters and ensures they are applied to the account.

@param UpdateBusinessSettingsRequest The request containing the updated settings. @return UpdateBusinessSettingsResponse Returns the status and result of the update process. |
