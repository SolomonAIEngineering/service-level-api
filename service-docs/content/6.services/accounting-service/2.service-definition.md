...
- [accounting_service/v1/request.proto](#accounting_service_v1_request-proto)
    - [CreateProfileRequest](#accounting_service-v1-CreateProfileRequest)
    - [DeleteProfileRequest](#accounting_service-v1-DeleteProfileRequest)
    - [ExchangePublicLinkTokenForAccountTokenRequest](#accounting_service-v1-ExchangePublicLinkTokenForAccountTokenRequest)
    - [GetLinkTokenRequest](#accounting_service-v1-GetLinkTokenRequest)
    ...
    - [ReadProfileRequest](#accounting_service-v1-ReadProfileRequest)
    - [ReadynessCheckRequest](#accounting_service-v1-ReadynessCheckRequest)
    - [UpdateProfileRequest](#accounting_service-v1-UpdateProfileRequest)
  
- [accounting_service/v1/response.proto](#accounting_service_v1_response-proto)
    - [CreateProfileResponse](#accounting_service-v1-CreateProfileResponse)
    - [DeleteProfileResponse](#accounting_service-v1-DeleteProfileResponse)
    - [ExchangePublicLinkTokenForAccountTokenResponse](#accounting_service-v1-ExchangePublicLinkTokenForAccountTokenResponse)
    - [GetLinkTokenResponse](#accounting_service-v1-GetLinkTokenResponse)
    ...
    - [ReadProfileResponse](#accounting_service-v1-ReadProfileResponse)
    - [ReadynessCheckResponse](#accounting_service-v1-ReadynessCheckResponse)
    - [UpdateProfileResponse](#accounting_service-v1-UpdateProfileResponse)
...
<a name="accounting_service-v1-CreateProfileRequest"></a>

### CreateProfileRequest
Defines a message named CreateProfileRequest.
...
<a name="accounting_service-v1-DeleteProfileRequest"></a>
...
<a name="accounting_service-v1-GetLinkTokenRequest"></a>

### GetLinkTokenRequest
Defines a message named GetLinkTokenRequest.


| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| user_id | [uint64](#uint64) |  | The user id Validations: - user_id must be greater than 0 This unique identifier typically represents the ID for your end user in your product&#39;s database. This value must be distinct from other Linked Accounts&#39; unique identifiers. |
...
<a name="accounting_service-v1-ReadProfileRequest"></a>
...
<a name="accounting_service-v1-UpdateProfileRequest"></a>

### UpdateProfileRequest
Defines a message named UpdateProfileRequest.
...
<a name="accounting_service-v1-CreateProfileResponse"></a>

### CreateProfileResponse
Defines a message named CreatesProfileResponse.
...
<a name="accounting_service-v1-DeleteProfileResponse"></a>

### DeleteProfileResponse
Defines a message named DeleteProfileResponse.
...
<a name="accounting_service-v1-GetLinkTokenResponse"></a>
...
<a name="accounting_service-v1-ReadProfileResponse"></a>
...
<a name="accounting_service-v1-UpdateProfileResponse"></a>

### UpdateProfileResponse
Defines a message named UpdateProfileResponse.
...
| CreateProfile | [CreateProfileRequest](#accounting_service-v1-CreateProfileRequest) | [CreateProfileResponse](#accounting_service-v1-CreateProfileResponse) | creates a business accouting profile on the service |
| ReadProfile | [ReadProfileRequest](#accounting_service-v1-ReadProfileRequest) | [ReadProfileResponse](#accounting_service-v1-ReadProfileResponse) | gets business accounting profile |
| DeleteProfile | [DeleteProfileRequest](#accounting_service-v1-DeleteProfileRequest) | [DeleteProfileResponse](#accounting_service-v1-DeleteProfileResponse) | delete business payroll profile |
| UpdateProfile | [UpdateProfileRequest](#accounting_service-v1-UpdateProfileRequest) | [UpdateProfileResponse](#accounting_service-v1-UpdateProfileResponse) | updates a business account |
| GetLinkToken | [GetLinkTokenRequest](#accounting_service-v1-GetLinkTokenRequest) | [GetLinkTokenResponse](#accounting_service-v1-GetLinkTokenResponse) | enables the client to get a link_token to initialize a Link session for your end user. |
