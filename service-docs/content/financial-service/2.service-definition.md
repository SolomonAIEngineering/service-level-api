...
- [financial_service/v1/message_financial_service.proto](#financial_service_v1_message_financial_service-proto)
    ...
    - [TransactionNote](#financial_service-v1-TransactionNote)
...
| status | [BankAccountStatus](#financial_service-v1-BankAccountStatus) |  | the bank account status |
| transactions | [PlaidAccountInvestmentTransaction](#financial_service-v1-PlaidAccountInvestmentTransaction) | repeated |  |
...
| notes | [TransactionNote](#financial_service-v1-TransactionNote) | repeated | Notes associated with this investment transaction. @gotag: ch:&#34;notes&#34; |
...
| notes | [TransactionNote](#financial_service-v1-TransactionNote) | repeated | Notes associated with this recurring transaction. |
...
| notes | [TransactionNote](#financial_service-v1-TransactionNote) | repeated | Notes associated with this transaction. |
...
<a name="financial_service-v1-TransactionNote"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| id | [uint64](#uint64) |  | Id: An unsigned 64-bit integer representing the unique ID of the transaction note. |
| transaction_id | [string](#string) |  | Transaction Id: A string representing the transaction ID associated with this note. |
| note | [string](#string) |  | Note: A string field for storing the note text. |
| created_at | [google.protobuf.Timestamp](#google-protobuf-Timestamp) |  | Time Note Was Created At: A timestamp indicating when this note was created. |
| updated_at | [google.protobuf.Timestamp](#google-protobuf-Timestamp) |  | Time Note Was Updated: A timestamp indicating when this note was last updated. |
| user_id | [uint64](#uint64) |  | User Id That Created The Note: An unsigned 64-bit integer representing the user ID associated with this note. |
