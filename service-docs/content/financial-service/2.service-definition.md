...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| task_id | [uint64](#uint64) |  | The task id Validations: - task_id must be greater than 0 |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| task_id | [uint64](#uint64) |  | The task id |
| status | [TaskState](#financial_service-v1-TaskState) |  | The task status |
| completed_at | [google.protobuf.Timestamp](#google-protobuf-Timestamp) |  | The time the task completed |
| is_orphaned | [bool](#bool) |  | Wether the task is orphaned |
| task_type | [string](#string) |  | The type of task that was executed |
