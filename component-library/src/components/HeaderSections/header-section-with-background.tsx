...
interface HeaderSectionWithBackgroundProps {
  /**
...
const HeaderSectionWithBackground: React.FC<
  HeaderSectionWithBackgroundProps
> = ({
  alignment = "left",
  ...
  return (
    <Card
      className={`relative isolate overflow-hidden bg-gray-900 ${
        isCenterAligned ? "px-6" : ""
      } py-24 sm:py-32 lg:px-8`}
    >
      <img
        src={backgroundImage}
        alt=""
        className="absolute inset-0 -z-10 h-fit w-full object-cover"
      />
      <div
      ...
      <div
        className={`mx-auto max-w-2xl ${
          isCenterAligned ? "text-center" : "lg:mx-0"
        }`}
      >
...
export { HeaderSectionWithBackground };
