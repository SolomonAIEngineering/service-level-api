...
/**
 * StackedLayoutNavWithPageHeader Component
 * @param props Component properties
 * @returns JSX Element
 */
const StackedLayoutNavWithPageHeader: FC<
  StackedLayoutNavWithPageHeaderProps
> = ({ user, navigation, userNavigation, title }) => {
  return (
    <>
...
export default StackedLayoutNavWithPageHeader;
