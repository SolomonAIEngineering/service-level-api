            ...
            <div className="fixed inset-0 flex">
              ...
              >
                <Dialog.Panel className="relative flex flex-1 w-full max-w-xs mr-16">
                  ...
                  <div className="flex flex-col px-6 pb-4 overflow-y-auto bg-black grow gap-y-5">
                    ...
                    <nav className="flex flex-col flex-1">
                      <ul role="list" className="flex flex-col flex-1 gap-y-7">
                        ...
                        <li className="mt-auto">
                          <a
                            href="#"
                            className="flex p-2 -mx-2 text-sm font-semibold leading-6 text-blue-200 rounded-md group gap-x-3 hover:bg-blue-700 hover:text-white"
                          >
                            <Cog6ToothIcon
                              className="w-6 h-6 text-blue-200 shrink-0 group-hover:text-white"
                              aria-hidden="true"
                            />
                            Settings
                          </a>
