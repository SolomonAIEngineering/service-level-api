...
import { Plugin, PluginList } from 'src/types/business-ai/plugin';
...
export const PluginSelect: FC<Props> = ({
  ...
  return (
    <div className="flex flex-col">
      <div className="w-full pr-2 mb-1 bg-transparent border rounded border-neutral-200 text-neutral-900 dark:border-neutral-600 dark:text-white">
        <select
          ref={selectRef}
          className="w-full p-2 bg-transparent cursor-pointer"
