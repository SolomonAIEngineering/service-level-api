...
export interface RefactorEmailAndAuth0UserIdExistsRequest {
  auth0UserId?: string;
  /** the account id associated with the user */
  email?: string;
}

export interface RefactorEmailAndAuth0UserIdExistsResponse {
  success?: boolean;
}
...
export type UpdateAuth0UserIdByEmailData = any;
