...
var K = (n, t, s) => t in n ? H(n, t, { enumerable: !0, configurable: !0, writable: !0, value: s }) : n[t] = s;
var e = (n, t, s) => (K(n, typeof t != "symbol" ? t + "" : t, s), s);
class Q {
  /**
...
class M {
  ...
  constructor(t) {
    ...
    t && Object.assign(this, {
      ...t,
      response: {
        errors: (o = (s = t == null ? void 0 : t.response) == null ? void 0 : s.errors) == null ? void 0 : o.map((c) => new X(c))
      }
    });
  }
}
class N {
  ...
  constructor(t) {
    ...
    t && Object.assign(this, {
      ...t,
      http_body: new M(t == null ? void 0 : t.http_body),
...
class a {
  ...
  constructor(t) {
     ...
     */
    e(this, "error_message", new N());
    t && Object.assign(this, {
      ...t,
      error_message: new N(t == null ? void 0 : t.error_message)
    });
  }
}
class d {
...
class I {
  ...
  static randomInstance() {
    return new I({
      ...
      category: Math.random() > 0.5 ? y.randomInstance() : void 0
    });
  }
}
class f {
  ...
  static randomInstance() {
    return new f({
      ...
      isCompleted: L(),
      budget: Math.random() > 0.5 ? I.randomInstance() : void 0
    });
  }
}
class oe {
...
class S {
   ...
   */
  static randomInstance() {
    const t = r(5, 10), s = Array.from({ length: t }, () => f.randomInstance());
    return new S({
      id: r(1, 1e4).toString(),
      ...
      milestones: s,
      forecasts: Math.random() > 0.1 ? b.randomInstance() : void 0
    });
  }
}
class C {
   ...
   */
  static randomInstance() {
    const t = r(0, 5), s = Array.from({ length: t }, () => S.randomInstance());
    return new C({
      id: r(1, 1e4).toString(),
      goals: s,
...
class E {
  ...
  static randomInstance() {
    return new E({
      ...
      plaidAccountId: i(10),
      subtype: i(10),
      holdings: Array.from({ length: 20 }, () => P.randomInstance()),
      securities: Array.from({ length: 20 }, () => d.randomInstance())
    });
  }
}
class A {
...
class k {
  ...
  static randomInstance() {
    return new k({
      ...
      aprs: Array.from({ length: r(0, 5) }, () => A.randomInstance()),
...
class D {
  constructor(t) {
    ...
    t && Object.assign(this, {
      ...t,
      stripeSubscriptions: new te(t == null ? void 0 : t.stripeSubscriptions),
      link: (s = t == null ? void 0 : t.link) == null ? void 0 : s.map((c) => new se(c)),
      actionableInsights: (o = t == null ? void 0 : t.actionableInsights) == null ? void 0 : o.map((c) => new ee(c))
    });
  }
}
class ae {
...
class g {
  ...
  static fromJSON(t) {
    return new g(O(t.typeUrl) ? String(t.typeUrl) : "", O(t.value) ? ne(t.value) : new Uint8Array(0));
  }
  toJSON() {
    const t = {};
    return this.typeUrl !== "" && (t.typeUrl = this.typeUrl), this.value.length !== 0 && (t.value = ie(this.value)), t;
  }
  static create(t) {
    return g.fromPartial(t ?? {});
  }
  static fromPartial(t) {
    const s = new g("", new Uint8Array(0));
...
class R {
  ...
  static randomInstance() {
    const t = () => Math.floor(Math.random() * 12) + 1, s = [
      ...
      "Utilities",
      "Rent"
    ], o = () => s[Math.floor(Math.random() * s.length)], c = () => parseFloat((Math.random() * 1e4).toFixed(2)), V = () => Math.floor(Math.random() * 1e3).toString();
    return new R({
      month: t(),
      mostExpensiveCategory: o(),
      numberOfTransactions: V(),
      totalExpenses: c(),
      totalIncome: c(),
...
class B {
  ...
  static randomInstance() {
    return new B({
      ...
      sign: r(0, 2) === 0 ? -1 : 1,
      personalFinanceCategoryPrimary: p([
        "Food",
        "Rent",
        "Transportation",
        "Entertainment",
...
class je extends a {
  constructor(s) {
    ...
    e(this, "user_financial_profile", {
      profile: new D(),
      financialContext: new w({})
    });
    s && Object.assign(this, {
      ...s,
      user_account: (s == null ? void 0 : s.user_account) ?? {},
      user_profile: s.user_profile !== void 0 ? new h(s.user_profile) : new h({}),
      user_financial_profile: {
        profile: new D((o = s == null ? void 0 : s.user_financial_profile) == null ? void 0 : o.profile),
        financialContext: new w(((c = s == null ? void 0 : s.user_financial_profile) == null ? void 0 : c.financialContext) ?? {})
      }
    });
  }
}
...
class Ge {
  constructor(t) {
    e(this, "account", new v());
    e(this, "communityIdsToFollow", []);
    e(this, "profileImage", "");
    e(this, "password", "");
    t && Object.assign(this, {
      ...t,
      account: new v(t == null ? void 0 : t.account)
    });
  }
  toJSON() {
    return {
...
class Vt {
  constructor(t) {
    ...
    t && Object.assign(this, {
      ...t,
      account: t != null && t.account ? t.account : void 0
    });
  }
  isValid() {
...
class Ht extends a {
  constructor(s) {
    ...
    s && Object.assign(this, {
      ...s,
      account: s != null && s.account ? s.account : void 0
    });
  }
}
class Kt {
  ...
  constructor(t) {
    ...
    t && Object.assign(this, {
      ...
      tags: (s = t == null ? void 0 : t.tags) == null ? void 0 : s.map((o) => new J(o)),
...
export {
  j as AccountBalanceHistoryClass,
  ee as ActionableInsightClass,
  Q as AddressClass,
  g as AnyClass,
  A as AprClass,
  Fe as AuthenticateRequest,
  je as AuthenticationResponse,
  M as BackendError,
  U as BankAccountClass,
  I as BudgetClass,
  y as CategoryClass,
  me as CategoryMetricsFinancialSubProfileClass,
  le as CategoryMonthlyExpenditureClass,
  he as CategoryMonthlyIncomeClass,
  ge as CategoryMonthlyTransactionCountClass,
  ze as CheckEmailExistsRequest,
  W as CheckEmailExistsResponse,
  Re as CheckUsernameExistsRequest,
  $ as CheckUsernameExistsResponse,
  Ge as CreateAccountRequest,
  k as CreditAccountClass,
  pe as DebtToIncomeRatioClass,
  N as ErrorMessage,
  X as ErrorMetadata,
  a as ErrorResponse,
  z as ExpenseMetricsClass,
  de as ExpenseMetricsFinancialSubProfileMetricsClass,
  D as FinancialProfileClass,
  R as FinancialProfileMetricsClass,
  Qt as FinancialServiceDataContract,
  b as ForecastClass,
  Be as GetAccountBalanceHistoryRequest,
  _e as GetAccountBalanceHistoryResponse,
  Ye as GetCategoryMonthlyTransactionCountRequest,
  We as GetCategoryMonthlyTransactionCountResponse,
  $e as GetDebtToIncomeRatioRequest,
  Ve as GetDebtToIncomeRatioResponse,
  He as GetExpenseMetricsRequest,
  Ke as GetExpenseMetricsResponse,
  Xe as GetFinancialProfileRequest,
  Ze as GetFinancialProfileResponse,
  qe as GetIncomeExpenseRatioRequest,
  et as GetIncomeExpenseRatioResponse,
  tt as GetIncomeMetricsRequest,
  st as GetIncomeMetricsResponse,
  Je as GetMelodyFinancialContextRequest,
  Qe as GetMelodyFinancialContextResponse,
  nt as GetMerchantMonthlyExpenditureRequest,
  it as GetMerchantMonthlyExpenditureResponse,
  rt as GetMonthlyBalanceRequest,
  ot as GetMonthlyBalanceResponse,
  at as GetMonthlyExpenditureRequest,
  ct as GetMonthlyExpenditureResponse,
  ut as GetMonthlyIncomeRequest,
  mt as GetMonthlyIncomeResponse,
  lt as GetMonthlySavingsRequest,
  ht as GetMonthlySavingsResponse,
  gt as GetMonthlyTotalQuantityBySecurityAndUserRequest,
  pt as GetMonthlyTotalQuantityBySecurityAndUserResponse,
  dt as GetMonthlyTransactionCountRequest,
  yt as GetMonthlyTransactionCountResponse,
  It as GetPaymentChannelMonthlyExpenditureRequest,
  ft as GetPaymentChannelMonthlyExpenditureResponse,
  bt as GetReCurringTransactionsRequest,
  St as GetReCurringTransactionsResponse,
  Ct as GetTotalInvestmentBySecurityRequest,
  Pt as GetTotalInvestmentBySecurityResponse,
  Mt as GetTransactionAggregatesRequest,
  At as GetTransactionAggregatesResponse,
  Tt as GetTransactionsForBankAccountRequest,
  Nt as GetTransactionsForBankAccountResponse,
  xt as GetTransactionsRequest,
  Dt as GetTransactionsResponse,
  Ot as GetUpdatedUserAccountResponse,
  vt as GetUserAccountBalanceHistoryRequest,
  wt as GetUserAccountBalanceHistoryResponse,
  Lt as GetUserCategoryMonthlyExpenditureRequest,
  Et as GetUserCategoryMonthlyExpenditureResponse,
  kt as GetUserCategoryMonthlyIncomeRequest,
  Ut as GetUserCategoryMonthlyIncomeResponse,
  ye as IncomeExpenseRatioClass,
  G as IncomeMetricsClass,
  Ie as IncomeMetricsFinancialSubProfileClass,
  P as InvesmentHoldingClass,
  E as InvestmentAccountClass,
  d as InvestmentSecurityClass,
  fe as InvestmentTransactionClass,
  se as LinkClass,
  be as LocationFinancialSubProfileClass,
  w as MelodyFinancialContextClass,
  Se as MerchantMetricsFinancialSubProfileClass,
  Ce as MerchantMonthlyExpenditureClass,
  f as MilestoneClass,
  Pe as MonthlyBalanceClass,
  Ae as MonthlyExpenditureClass,
  Me as MonthlyIncomeClass,
  Ne as MonthlySavingsClass,
  Te as MonthlyTotalQuantityBySecurityAndUserClass,
  xe as MonthlyTransactionCountClass,
  oe as MortgageAccountClass,
  De as PaymentChannelMetricsFinancialSubProfileClass,
  Oe as PaymentChannelMonthlyExpenditureClass,
  jt as PlaidExchangeTokenRequest,
  zt as PlaidExchangeTokenResponse,
  Rt as PlaidInitiateTokenExchangeRequest,
  Gt as PlaidInitiateTokenExchangeResponse,
  Yt as PlaidInitiateTokenUpdateRequest,
  Wt as PlaidInitiateTokenUpdateResponse,
  ae as PlaidLinkClass,
  _t as PlaidLinkRequest,
  Bt as PlaidLinkResponse,
  ce as PlaidSyncClass,
  C as PocketClass,
  ke as PublicationClass,
  _ as ReOccuringTransactionClass,
  Ft as RequestPasswordResetResponse,
  $t as ResetPasswordResponse,
  S as SmartGoalClass,
  Ue as SocialAccount,
  Ee as SocialBookmark,
  Jt as SocialServiceDataContract,
  h as SocialUserProfileClass,
  te as StripeSubscriptionClass,
  F as StudentLoanAccountClass,
  J as TagClass,
  ue as TokenClass,
  we as TotalInvestmentBySecurityClass,
  ve as TransactionAggregatesByMonthClass,
  B as TransactionClass,
  Vt as UpdateUserAccountRequest,
  Ht as UpdateUserAccountResponse,
  Kt as UserAccountClass,
  Le as UserFinancialHealthMetricsTableClass,
  v as UserRegistrationAccountDetails,
