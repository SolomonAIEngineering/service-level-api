import { BankAccount, CategoryMetricsFinancialSubProfile, CreditAccount, ExpenseMetricsFinancialSubProfileMetrics, IncomeMetricsFinancialSubProfile, InvestmentAccount, LocationFinancialSubProfile, MelodyFinancialContext as MelodyFinancialContext, MerchantMetricsFinancialSubProfile, MortgageAccount, PaymentChannelMetricsFinancialSubProfile, StudentLoanAccount } from 'src/data-contracts/financial-service/data-contracts';
/**
 ...
 */
declare class MelodyFinancialContextClass implements MelodyFinancialContext {
