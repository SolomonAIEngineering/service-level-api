 ...
 */
export declare class AddressClass implements AddressContract {
	address?: string;
	city?: string;
	state?: string;
	unit?: string;
 ...
 */
export declare class FinancialProfileClass implements UserProfile {
	/** id */
...
export declare class UserAccount implements UserAccountContract, UserAccountContractWithAccountID {
	address?: Address;
	bio?: string;
	email: string;
	firstname?: string;
...
export declare const BankAccountContext: React.Context<IBankAccount | undefined>;
