...
<a name="financial_service-v1-UserProfile"></a>
...
| Field   | Type                                             | Label | Description                                                        |
| ------- | ------------------------------------------------ | ----- | ------------------------------------------------------------------ |
| profile | [UserProfile](#financial_service-v1-UserProfile) |       | User profile to create Validations: - cannot be nil hence required |
...
| Field             | Type                                                                   | Label | Description                    |
| ----------------- | ---------------------------------------------------------------------- | ----- | ------------------------------ |
| profile           | [UserProfile](#financial_service-v1-UserProfile)                       |       |                                |
...
| Field   | Type                                             | Label | Description                                                    |
| ------- | ------------------------------------------------ | ----- | -------------------------------------------------------------- |
| profile | [UserProfile](#financial_service-v1-UserProfile) |       | User profile to update Validation: - cannot nil hence required |
...
MergeGetPublicLinkToken enables the client to get a link*token to initialize a Link session for your end user. |
